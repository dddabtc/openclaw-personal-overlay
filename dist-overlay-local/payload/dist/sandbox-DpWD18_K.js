import { It as STATE_DIR, S as CHANNEL_IDS, _ as defaultRuntime, ot as resolveUserPath } from "./entry.js";
import { t as formatCliCommand } from "./command-format-D3syQOZg.js";
import { l as resolveAgentIdFromSessionKey, s as normalizeAgentId } from "./session-key-DjZ7Z1hW.js";
import { C as ensureAgentWorkspace, S as DEFAULT_USER_FILENAME, _ as DEFAULT_IDENTITY_FILENAME, b as DEFAULT_SOUL_FILENAME, d as resolveSessionAgentId, g as DEFAULT_HEARTBEAT_FILENAME, h as DEFAULT_BOOTSTRAP_FILENAME, m as DEFAULT_AGENT_WORKSPACE_DIR, p as DEFAULT_AGENTS_FILENAME, r as resolveAgentConfig, x as DEFAULT_TOOLS_FILENAME } from "./agent-scope-DhajVyRS.js";
import { d as resolveSandboxInputPath, f as resolveSandboxPath, g as sanitizeEnvVars, o as syncSkillsToWorkspace } from "./skills-Bq1s47OA.js";
...
import { M as canonicalizeMainSessionAlias, N as resolveAgentMainSessionKey, V as acquireSessionWriteLock } from "./sessions-CsRDsl2f.js";
import { A as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, D as DEFAULT_BROWSER_EVALUATE_ENABLED, O as DEFAULT_OPENCLAW_BROWSER_COLOR } from "./chrome-DkGieswr.js";
import { a as resolveProfile, m as resolveBrowserControlAuth, p as ensureBrowserControlAuth, t as createBrowserRouteContext } from "./server-context-CX9PSgDC.js";
import { t as registerBrowserRoutes } from "./routes-DeZNDmn_.js";
