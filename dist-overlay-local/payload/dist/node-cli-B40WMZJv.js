...
import { B as theme, R as colorize } from "./utils-CP9YLh6M.js";
import "./registry-B-j4DRfe.js";
import { f as defaultRuntime } from "./subsystem-BCQGGxdd.js";
import "./exec-DYqRzFbo.js";
import { r as resolveAgentConfig } from "./agent-scope-B36jktKj.js";
...
import { H as VERSION, i as loadConfig } from "./config-HiRdak1Z.js";
import { _ as sanitizeHostExecEnv } from "./manifest-registry-D2lPzXIl.js";
import "./chrome-DyU5oS8r.js";
import "./tailscale-Lro1Kj8C.js";
import "./auth-G84EF23T.js";
import { i as resolveBrowserConfig } from "./server-context-DZ5TWZsK.js";
...
import { n as createBrowserRouteDispatcher, r as getMachineDisplayName, t as withTimeout } from "./with-timeout-DOqlqARN.js";
import { Xt as loadOrCreateDeviceIdentity, t as GatewayClient } from "./client-DxXj-g8m.js";
...
import { g as resolveNodeWindowsTaskName, h as resolveNodeSystemdServiceName, m as resolveNodeLaunchAgentLabel, s as formatNodeServiceDescription } from "./constants-CEbQvI8z.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-B_baz5L6.js";
import "./runtime-guard-CiTT2sxK.js";
import { c as buildNodeServiceEnvironment, g as resolveNodeProgramArguments, o as resolveGatewayDevMode, p as resolvePreferredNodePath, r as isGatewayDaemonRuntime, s as emitNodeRuntimeWarning, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CEAM9avN.js";
import "./systemd-B9qciaS6.js";
import { s as resolveGatewayLogPaths } from "./service-6NL-JAsm.js";
import { a as createCliStatusTextStyles, f as resolveRuntimeStatusColor, g as installDaemonServiceAndEmit, h as createDaemonActionContext, i as runServiceUninstall, m as buildDaemonServiceSnapshot, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-DgEX8G8u.js";
import { s as formatRuntimeStatus } from "./systemd-hints-CUs2G-7A.js";
...
async function handleSystemRunInvoke(opts) {
	...
	const env = opts.sanitizeEnv(opts.params.env ?? void 0);
	...
	if (process.platform === "darwin") {
		const approvalDecision = opts.params.approvalDecision === "allow-once" || opts.params.approvalDecision === "allow-always" ? opts.params.approvalDecision : null;
		const execRequest = {
			command: argv,
