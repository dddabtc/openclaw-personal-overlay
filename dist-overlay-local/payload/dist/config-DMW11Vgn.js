...
import { Bt as resolveConfigPathCandidate, Ft as DEFAULT_GATEWAY_PORT, Gt as resolveLegacyStateDirs, Ht as resolveGatewayLockDir, It as STATE_DIR, Jt as resolveOAuthPath, Kt as resolveNewStateDir, Lt as isNixMode, Pt as CONFIG_PATH, Q as isRecord, Rt as resolveCanonicalConfigPath, S as CHANNEL_IDS, Ut as resolveGatewayPort, Vt as resolveDefaultConfigCandidates, Wt as resolveIsNixMode, Yt as resolveStateDir, j as normalizeChatChannelId, mt as isPlainObject$1, ot as resolveUserPath, pn as resolveRequiredHomeDir, qt as resolveOAuthDir, rt as resolveConfigDir, zt as resolveConfigPath } from "./entry.js";
import { At as resolveShellEnvFallbackTimeoutMs, Mt as shouldEnableShellEnvFallback, R as parseModelRef, Vt as DEFAULT_CONTEXT_TOKENS, jt as shouldDeferShellEnvFallback, kt as loadShellEnvFallback } from "./auth-profiles-C7RTY9Sv.js";
import { s as normalizeAgentId, t as DEFAULT_AGENT_ID } from "./session-key-DjZ7Z1hW.js";
import { c as resolveAgentWorkspaceDir, l as resolveDefaultAgentId } from "./agent-scope-DhajVyRS.js";
import { n as isPathInside } from "./scan-paths-B22E7-Cg.js";
import { d as resolveEnableState, f as resolveMemorySlotDecision, g as normalizeEnvVarKey, h as isDangerousHostEnvVarName, n as loadPluginManifestRegistry, u as normalizePluginsConfig } from "./manifest-registry-XSxPcu0S.js";
...
const OpenClawSchema = z.object({
	...
	sessionPolicies: z.object({ main: z.object({
...
//#endregion
export { parseConfigPath as A, resolveAgentMaxConcurrent as B, parseDurationMs as C, setConfigOverride as D, resetConfigOverrides as E, isSafeExecutableValue as F, VERSION as H, INCLUDE_KEY as I, MAX_INCLUDE_DEPTH as L, unsetConfigValueAtPath as M, applyMergePatch as N, unsetConfigOverride as O, applyLegacyMigrations as P, collectConfigServiceEnvVars as R, sensitive as S, getConfigOverrides as T, resolveRuntimeServiceVersion as U, resolveSubagentMaxConcurrent as V, loadDotEnv as W, isInboundPathAllowed as _, parseConfigJson5 as a, resolveIMessageRemoteAttachmentRoots as b, resolveConfigSnapshotHash as c, OpenClawSchema as d, parseByteSize as f, DEFAULT_IMESSAGE_ATTACHMENT_ROOTS as g, resolveTelegramCustomCommands as h, loadConfig as i, setConfigValueAtPath as j, getConfigValueAtPath as k, writeConfigFile as l, normalizeTelegramCommandName as m, migrateLegacyConfig as n, readConfigFileSnapshot as o, TELEGRAM_COMMAND_NAME_PATTERN as p, createConfigIO as r, readConfigFileSnapshotForWrite as s, config_exports as t, validateConfigObjectWithPlugins as u, mergeInboundPathRoots as v, validateJsonSchemaValue as w, normalizeScpRemoteHost as x, resolveIMessageAttachmentRoots as y, DEFAULT_SUBAGENT_MAX_SPAWN_DEPTH as z };