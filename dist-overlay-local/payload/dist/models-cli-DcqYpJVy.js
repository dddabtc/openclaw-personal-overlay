...
import { Ct as resolveUsageProviderId, St as formatUsageWindowSummary, bt as loadProviderUsageSummary, dr as maskApiKey, fr as DEFAULT_OAUTH_WARN_MS, l as runEmbeddedPiAgent, mr as formatRemainingShort, pr as buildAuthHealthSummary, qt as describeFailoverError } from "./reply-CeilQQUh.js";
import "./registry-B-j4DRfe.js";
import { f as defaultRuntime } from "./subsystem-BCQGGxdd.js";
import "./exec-DYqRzFbo.js";
import { D as resolveDefaultAgentWorkspaceDir, a as resolveAgentModelFallbacksOverride, c as resolveAgentWorkspaceDir, i as resolveAgentDir, l as resolveDefaultAgentId, o as resolveAgentModelPrimary } from "./agent-scope-B36jktKj.js";
import { At as ensureAuthProfileStore, Dt as setAuthProfileOrder, Ft as resolveOpenClawAgentDir, G as getCustomProviderApiKey, Gt as DEFAULT_MODEL, J as resolveAwsSdkEnvVarName, Kt as DEFAULT_PROVIDER, Ot as upsertAuthProfile, Pt as resolveAuthStorePathForDisplay, Tt as listProfilesForProvider, Vt as resolveAuthProfileDisplayLabel, Y as resolveEnvApiKey, Z as getShellEnvAppliedKeys, _t as resolveProfileUnusableUntilForDisplay, ft as resolveAuthProfileOrder, g as resolveModelRefFromString, i as findNormalizedProviderValue, l as normalizeProviderId, m as resolveDefaultModelForAgent, nt as shouldEnableShellEnvFallback, p as resolveConfiguredModelRef, q as resolveApiKeyForProvider, r as buildModelAliasIndex, s as modelKey, u as parseModelRef } from "./model-selection-mHHEzs4Y.js";
...
import { C as parseDurationMs, i as loadConfig } from "./config-HiRdak1Z.js";
import "./manifest-registry-D2lPzXIl.js";
import "./runner-BMiD7Bzr.js";
import "./image-_YQgqCp8.js";
import { t as ensureOpenClawModelsJson } from "./models-config-DDf0A41J.js";
...
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-C6eomcf_.js";
...
import { i as resolveForwardCompatModel, r as ANTIGRAVITY_OPUS_46_FORWARD_COMPAT_CANDIDATES } from "./model-CHiDbZyw.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-XevKf-tr.js";
import "./help-format-BDi1KLKw.js";
import { r as withProgressTotals } from "./progress-4MG2cm3p.js";
...
import { f as openUrl } from "./onboard-helpers-G9Oq_RlQ.js";
...
import { t as createClackPrompter } from "./clack-prompter-Bn__8Mbr.js";
import { t as renderTable } from "./table-DQ25Z456.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-D1rP7U2U.js";
import { n as redactSecrets } from "./format-DNqZrSx7.js";
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-BBulfnO2.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-BPnpjvqi.js";
import { n as logConfigUpdated } from "./logging-C81FDh59.js";
import { a as createVpsAwareOAuthHandlers, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-Bfn3WDY2.js";
import { t as ensurePiAuthJsonFromAuthProfiles } from "./system-cli-C8kVyvg4.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./config-HiRdak1Z.js").then((n) => n.t);
	const { ensureAuthProfileStore } = await import("./model-selection-mHHEzs4Y.js").then((n) => n.dt);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-CHiDbZyw.js").then((n) => n.t);
