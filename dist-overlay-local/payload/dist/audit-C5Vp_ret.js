...
import { l as resolveDefaultAgentId } from "./agent-scope-DhajVyRS.js";
import { a as MANIFEST_KEY, n as isPathInside, t as extensionUsesSkippedScannerPath } from "./scan-paths-B22E7-Cg.js";
import { i as loadWorkspaceSkillEntries } from "./skills-Bq1s47OA.js";
import { u as normalizePluginsConfig } from "./manifest-registry-XSxPcu0S.js";
import { I as INCLUDE_KEY, L as MAX_INCLUDE_DEPTH, r as createConfigIO } from "./config-DMW11Vgn.js";
import { t as GatewayClient } from "./client-DrK7aLru.js";
import { c as READ_SCOPE, t as buildGatewayConnectionDetails } from "./call-DpGX4uMX.js";
...
import { S as resolveToolProfilePolicy, f as resolveSandboxConfigForAgent, k as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, l as execDockerRaw, m as resolveSandboxToolPolicyForAgent, u as getBlockedBindReason } from "./sandbox-DpWD18_K.js";
import { a as resolveGatewayAuth } from "./auth-BcWLEKcS.js";
import { a as resolveProfile, i as resolveBrowserConfig, m as resolveBrowserControlAuth } from "./server-context-CX9PSgDC.js";
import { n as formatErrorMessage } from "./errors-Ba_ROWsq.js";
import { l as normalizeStringEntries } from "./dock-BkVflx2Q.js";
import { a as resolveNativeSkillsEnabled, i as resolveNativeCommandsEnabled } from "./commands-j9S9qRB6.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-Dw0EowUJ.js";
import { i as readChannelAllowFromStore } from "./pairing-store-BqeL7tj7.js";
import { n as isToolAllowedByPolicies, o as pickSandboxToolPolicy } from "./pi-tools.policy-PdQU4Q59.js";
...
import { t as scanDirectoryWithSummary } from "./skill-scanner-Cb7mXGIR.js";
...
function collectExecRuntimeFindings(cfg) {
	...
	const riskyAgents = (Array.isArray(cfg.agents?.list) ? cfg.agents.list : []).filter((entry) => entry && typeof entry === "object" && typeof entry.id === "string" && entry.tools?.exec?.host === "sandbox" && resolveSandboxConfigForAgent(cfg, entry.id).mode === "off").map((entry) => entry.id).slice(0, 5);
