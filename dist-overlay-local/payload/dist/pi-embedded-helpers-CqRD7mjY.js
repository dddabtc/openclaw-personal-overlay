...
import { n as resolveAgentConfig, u as resolveSessionAgentId } from "./agent-scope-BaNPxUDt.js";
import { r as defaultRuntime, t as createSubsystemLogger } from "./subsystem-B5g771Td.js";
import { _ as runExec, a as DEFAULT_IDENTITY_FILENAME, c as DEFAULT_USER_FILENAME, i as DEFAULT_HEARTBEAT_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-C6WgTYr8.js";
import { r as normalizeChannelId } from "./plugins-TJvbNSdo.js";
import { t as normalizeChatType } from "./chat-type-C_KiWNAH.js";
import { t as parseBooleanValue } from "./boolean-B8-BqKGQ.js";
import { t as formatCliCommand } from "./command-format-Ck2WauwF.js";
import { c as SafeOpenError, i as getImageMetadata, l as openFileWithinRoot, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-Di1Eegus.js";
import { S as isPidAlive, x as resolveProcessScopedMap } from "./model-auth-Ya7dMhOr.js";
import { o as listDeliverableMessageChannels, s as normalizeMessageChannel } from "./message-channel-CQCCb6Xy.js";
import { _ as parseDurationMs, a as writeConfigFile, n as loadConfig, s as parseByteSize, t as createConfigIO } from "./config-CysLz7WS.js";
import { A as DEFAULT_BROWSER_EVALUATE_ENABLED, D as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, E as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, M as DEFAULT_OPENCLAW_BROWSER_ENABLED, N as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, O as DEFAULT_AI_SNAPSHOT_MAX_CHARS, S as stopChromeExtensionRelayServer, _ as fetchJson, a as resolveOpenClawUserDataDir, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, g as appendCdpPath, h as withBrowserNavigationPolicy, i as launchOpenClawChrome, j as DEFAULT_OPENCLAW_BROWSER_COLOR, k as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, l as createTargetViaCdp, m as assertBrowserNavigationAllowed, n as isChromeCdpReady, o as stopOpenClawChrome, p as InvalidBrowserNavigationUrlError, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as fetchOk, w as isLoopbackHost, x as ensureChromeExtensionRelayServer } from "./chrome-CKATdJ66.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-DLRwGFBf.js";
...
import { r as saveMediaBuffer, t as ensureMediaDir } from "./store-BhpNzGEt.js";
import { d as getChannelDock, o as normalizeThinkLevel, v as normalizeHyphenSlug } from "./thinking-2XQ3oVP7.js";
...
import { t as sanitizeContentBlocksImages } from "./tool-images-VEoh5TwB.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-BG1O6xSR.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-BG1O6xSR.js")).closePlaywrightBrowserConnection();
		} catch {}
...
//#endregion
export { normalizeDeliveryContext as $, isTransientHttpError as A, DEFAULT_UPLOAD_DIR as At, resolveMirroredTranscriptText as B, expandToolGroups as Bt, isContextOverflowError as C, resolveGroupSessionKey as Ct, isRateLimitAssistantError as D, registerBrowserRoutes as Dt, isLikelyContextOverflowError as E, createBrowserRouteContext as Et, resolveSandboxContext as F, resolveSandboxConfigForAgent as Ft, updateLastRoute as G, compileGlobPatterns as Gt, loadSessionStore as H, normalizeToolName as Ht, resolveSandboxRuntimeStatus as I, applyOwnerOnlyToolPolicy as It, isCacheEnabled as J, ensureSessionHeader$1 as Jt, updateSessionStore as K, matchesAnyGlobPattern as Kt, extractDeliveryInfo as L, buildPluginToolGroups as Lt, parseImageSizeError as M, getBridgeAuthForPort as Mt, sanitizeUserFacingText as N, ensureBrowserControlAuth as Nt, isRawApiErrorPayload as O, resolveBrowserConfig as Ot, ensureSandboxWorkspaceForSession as P, resolveBrowserControlAuth as Pt, mergeDeliveryContext as Q, parseSessionThreadInfo as R, collectExplicitAllowlist as Rt, isCompactionFailureError as S, deriveSessionMetaPatch as St, isFailoverErrorMessage as T, resolveSessionLockMaxHoldFromTimeout as Tt, readSessionUpdatedAt as U, resolveToolProfilePolicy as Ut, resolveAndPersistSessionFile as V, mergeAlsoAllowPolicy as Vt, recordSessionMetaFromInbound as W, stripPluginOnlyAllowlist as Wt, deliveryContextFromSession as X, resolveBootstrapTotalMaxChars as Xt, resolveCacheTtlMs as Y, resolveBootstrapMaxChars as Yt, deliveryContextKey as Z, sanitizeGoogleTurnOrdering as Zt, formatRawAssistantErrorForUi as _, resolveFreshSessionTotalTokens as _t, isMessagingToolDuplicateNormalized as a, extractToolCallNames as at, isBillingAssistantError as b, resolveExplicitAgentSessionKey as bt, extractToolCallsFromAssistant as c, hasInterSessionUserProvenance as ct, isAntigravityClaude as d, evaluateSessionFreshness as dt, normalizeSessionDeliveryFields as et, isGoogleModelApi as f, resolveChannelResetConfig as ft, formatBillingErrorMessage as g, DEFAULT_RESET_TRIGGERS as gt, formatAssistantErrorText as h, resolveThreadFlag as ht, isMessagingToolDuplicate as i, countToolResults as it, parseImageDimensionError as j, resolveExistingPathsWithinRoot as jt, isTimeoutErrorMessage as k, resolveProfile as kt, extractToolResultId as l, normalizeInputProvenance as lt, classifyFailoverReason as m, resolveSessionResetType as mt, validateGeminiTurns as n, archiveSessionTranscripts as nt, normalizeTextForComparison as o, INPUT_PROVENANCE_KIND_VALUES as ot, BILLING_ERROR_USER_MESSAGE as p, resolveSessionResetPolicy as pt, updateSessionStoreEntry as q, buildBootstrapContextFiles as qt, pickFallbackThinkingLevel as r, capArrayByJsonBytes as rt, sanitizeSessionMessagesImages as s, applyInputProvenanceToUserMessage as st, validateAnthropicTurns as t, normalizeAccountId as tt, downgradeOpenAIReasoningBlocks as u, resolveSessionKey as ut, getApiErrorPayloadFingerprint as v, canonicalizeMainSessionAlias as vt, isFailoverAssistantError as w, acquireSessionWriteLock as wt, isCloudCodeAssistFormatError as x, resolveMainSessionKey as xt, isAuthAssistantError as y, resolveAgentMainSessionKey as yt, appendAssistantMessageToSessionTranscript as z, expandPolicyWithPluginGroups as zt };