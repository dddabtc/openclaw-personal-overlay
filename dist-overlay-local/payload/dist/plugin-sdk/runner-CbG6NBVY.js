...
import { S as resolveIMessageAttachmentRoots, b as isInboundPathAllowed, n as loadConfig, x as mergeInboundPathRoots, y as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS } from "./config-Dmuf-X_8.js";
import { B as resolveOpenClawAgentDir, T as resolveApiKeyForProvider, c as normalizeProviderId, h as normalizeGoogleModelId, w as requireApiKey } from "./model-selection-Jdj95NV3.js";
import { E as runExec } from "./agent-scope-Xg97m-eH.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-C-FmeLM-.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, o as fetchWithSsrFGuard, r as MediaFetchError } from "./local-roots-ClrRhF7x.js";
import { t as normalizeChatType } from "./chat-type-CEMQNtWX.js";
import { t as describeImageWithModel, x as ensureOpenClawModelsJson } from "./image-D9cm87J0.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-Ch8n0bhu.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-LbcEa65a.js").then((n) => n.r);
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-Bn7mOXpp.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
