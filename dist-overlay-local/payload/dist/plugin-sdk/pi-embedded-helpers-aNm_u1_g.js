import { c as normalizeMainKey, l as resolveAgentIdFromSessionKey, m as normalizeOptionalAccountId, r as buildAgentMainSessionKey, s as normalizeAgentId, t as DEFAULT_AGENT_ID } from "./session-key-C_0eELjb.js";
import { i as resolveGatewayPort, t as STATE_DIR, u as resolveRequiredHomeDir } from "./paths-DVWx7USN.js";
import { r as normalizeChannelId } from "./plugins-DibeMwuf.js";
import { A as normalizeE164, P as resolveUserPath, V as truncateUtf16Safe, t as CHANNEL_IDS, ut as resolvePreferredOpenClawTmpDir } from "./registry-BODM0liu.js";
import { R as parseDurationMs, a as writeConfigFile, n as loadConfig, s as parseByteSize, t as createConfigIO } from "./config-Dmuf-X_8.js";
import { i as defaultRuntime, t as createSubsystemLogger } from "./subsystem-CcWTQzT4.js";
import { i as parseBooleanValue, t as formatCliCommand } from "./command-format-DlCJ6Vf_.js";
import { U as resolveProcessScopedMap, W as isPidAlive } from "./model-selection-Jdj95NV3.js";
import { E as runExec, _ as DEFAULT_SOUL_FILENAME, b as ensureAgentWorkspace, f as DEFAULT_AGENTS_FILENAME, g as DEFAULT_IDENTITY_FILENAME, h as DEFAULT_HEARTBEAT_FILENAME, m as DEFAULT_BOOTSTRAP_FILENAME, n as resolveAgentConfig, p as DEFAULT_AGENT_WORKSPACE_DIR, u as resolveSessionAgentId, v as DEFAULT_TOOLS_FILENAME, y as DEFAULT_USER_FILENAME } from "./agent-scope-Xg97m-eH.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-Bv8oZiTO.js";
import { b as openFileWithinRoot, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, y as SafeOpenError } from "./image-ops-C-FmeLM-.js";
import { t as SsrFBlockedError } from "./ssrf-DKZ8eBrk.js";
import { o as listDeliverableMessageChannels, s as normalizeMessageChannel } from "./message-channel-CUaOB1wh.js";
import { t as normalizeChatType } from "./chat-type-CEMQNtWX.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-KxE68Cxp.js";
import { a as syncSkillsToWorkspace, h as safeEqualSecret, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-DHgtld9F.js";
import { A as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, C as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, D as DEFAULT_BROWSER_EVALUATE_ENABLED, E as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, O as DEFAULT_OPENCLAW_BROWSER_COLOR, S as stopChromeExtensionRelayServer, T as DEFAULT_AI_SNAPSHOT_MAX_CHARS, _ as fetchJson, a as resolveOpenClawUserDataDir, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, g as appendCdpPath, h as withBrowserNavigationPolicy, i as launchOpenClawChrome, j as isLoopbackHost, k as DEFAULT_OPENCLAW_BROWSER_ENABLED, l as createTargetViaCdp, m as assertBrowserNavigationAllowed, n as isChromeCdpReady, o as stopOpenClawChrome, p as InvalidBrowserNavigationUrlError, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as fetchOk, w as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, x as ensureChromeExtensionRelayServer } from "./chrome-CLChZob_.js";
import { A as normalizeHyphenSlug, d as getChannelDock, o as normalizeThinkLevel } from "./thinking-CT0vXDJs.js";
import { n as resolveConversationLabel } from "./conversation-label-yNSj43Jt.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-BNQjLbn7.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-x1D4Vniz.js";
import { i as saveMediaBuffer, t as ensureMediaDir } from "./store-DGNHfylD.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CWylagfC.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-CWylagfC.js")).closePlaywrightBrowserConnection();
		} catch {}
...
//#endregion
export { normalizeToolName as $, isTransientHttpError as A, countToolResults as At, resolveProfile as B, resolveChannelResetConfig as Bt, isContextOverflowError as C, deliveryContextKey as Ct, isRateLimitAssistantError as D, normalizeAccountId as Dt, isLikelyContextOverflowError as E, normalizeSessionDeliveryFields as Et, resolveSandboxContext as F, normalizeInputProvenance as Ft, resolveBrowserControlAuth as G, resolveFreshSessionTotalTokens as Gt, resolveExistingPathsWithinRoot as H, resolveSessionResetType as Ht, resolveSandboxRuntimeStatus as I, acquireSessionWriteLock as It, buildPluginToolGroups as J, resolveMainSessionKey as Jt, resolveSandboxConfigForAgent as K, canonicalizeMainSessionAlias as Kt, createBrowserRouteContext as L, resolveSessionLockMaxHoldFromTimeout as Lt, parseImageSizeError as M, INPUT_PROVENANCE_KIND_VALUES as Mt, sanitizeUserFacingText as N, applyInputProvenanceToUserMessage as Nt, isRawApiErrorPayload as O, archiveSessionTranscripts as Ot, ensureSandboxWorkspaceForSession as P, hasInterSessionUserProvenance as Pt, mergeAlsoAllowPolicy as Q, registerBrowserRoutes as R, resolveSessionKey as Rt, isCompactionFailureError as S, deliveryContextFromSession as St, isFailoverErrorMessage as T, normalizeDeliveryContext as Tt, getBridgeAuthForPort as U, resolveThreadFlag as Ut, DEFAULT_UPLOAD_DIR as V, resolveSessionResetPolicy as Vt, ensureBrowserControlAuth as W, DEFAULT_RESET_TRIGGERS as Wt, expandPolicyWithPluginGroups as X, resolveGroupSessionKey as Xt, collectExplicitAllowlist as Y, deriveSessionMetaPatch as Yt, expandToolGroups as Z, formatRawAssistantErrorForUi as _, updateLastRoute as _t, isMessagingToolDuplicateNormalized as a, ensureSessionHeader as at, isBillingAssistantError as b, isCacheEnabled as bt, extractToolCallsFromAssistant as c, sanitizeGoogleTurnOrdering as ct, isAntigravityClaude as d, appendAssistantMessageToSessionTranscript as dt, resolveToolProfilePolicy as et, isGoogleModelApi as f, resolveMirroredTranscriptText as ft, formatBillingErrorMessage as g, recordSessionMetaFromInbound as gt, formatAssistantErrorText as h, readSessionUpdatedAt as ht, isMessagingToolDuplicate as i, buildBootstrapContextFiles as it, parseImageDimensionError as j, extractToolCallNames as jt, isTimeoutErrorMessage as k, capArrayByJsonBytes as kt, extractToolResultId as l, extractDeliveryInfo as lt, classifyFailoverReason as m, loadSessionStore as mt, validateGeminiTurns as n, compileGlobPatterns as nt, normalizeTextForComparison as o, resolveBootstrapMaxChars as ot, BILLING_ERROR_USER_MESSAGE as p, resolveAndPersistSessionFile as pt, applyOwnerOnlyToolPolicy as q, resolveExplicitAgentSessionKey as qt, pickFallbackThinkingLevel as r, matchesAnyGlobPattern as rt, sanitizeSessionMessagesImages as s, resolveBootstrapTotalMaxChars as st, validateAnthropicTurns as t, stripPluginOnlyAllowlist as tt, downgradeOpenAIReasoningBlocks as u, parseSessionThreadInfo as ut, getApiErrorPayloadFingerprint as v, updateSessionStore as vt, isFailoverAssistantError as w, mergeDeliveryContext as wt, isCloudCodeAssistFormatError as x, resolveCacheTtlMs as xt, isAuthAssistantError as y, updateSessionStoreEntry as yt, resolveBrowserConfig as z, evaluateSessionFreshness as zt };