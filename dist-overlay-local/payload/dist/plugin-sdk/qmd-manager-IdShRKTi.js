import { y as parseAgentSessionKey } from "./session-key-C_0eELjb.js";
...
import { s as resolveAgentWorkspaceDir } from "./agent-scope-Xg97m-eH.js";
import "./redact-DPnDWsnT.js";
import "./paths-BNQjLbn7.js";
import { _ as statRegularFile, g as isFileMissingError, n as buildSessionEntry, r as listSessionFilesForAgent, t as requireNodeSqlite } from "./sqlite-BmIX4qWz.js";
...
var QmdMemoryManager = class QmdMemoryManager {
	...
	async search(query, opts) {
		...
		let parsed;
		try {
			if (collectionNames.length > 1) parsed = await this.runQueryAcrossCollections(trimmed, limit, collectionNames, qmdSearchCommand);
			else {
			...
			if (qmdSearchCommand !== "query" && this.isUnsupportedQmdOptionError(err)) {
				...
				try {
					if (collectionNames.length > 1) parsed = await this.runQueryAcrossCollections(trimmed, limit, collectionNames, "query");
					else {
