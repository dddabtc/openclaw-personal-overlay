...
import { S as resolveTelegramAccount, n as listChannelPlugins, t as getChannelPlugin } from "./plugins-DibeMwuf.js";
import { t as resolveFetch } from "./fetch-b2Zm8y7X.js";
import { F as safeParseJson, K as logVerbose, U as danger } from "./registry-BODM0liu.js";
import { n as loadConfig } from "./config-Dmuf-X_8.js";
import { t as createSubsystemLogger } from "./subsystem-CcWTQzT4.js";
import { r as isTruthyEnvValue } from "./command-format-DlCJ6Vf_.js";
import { H as withFileLock$1 } from "./model-selection-Jdj95NV3.js";
...
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-uMQNJ7J0.js";
import { n as normalizePollInput } from "./polls-3WJMd-G-.js";
import { h as normalizeMimeType, p as isGifMedia, u as getFileExtension, v as mediaKindFromMime } from "./image-ops-C-FmeLM-.js";
import { a as loadWebMedia, n as markdownToIR, t as chunkMarkdownIR } from "./ir-GLTSswZ6.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-DXOal6UY.js";
...
function resolveTelegramStreamMode(telegramCfg) {
	if (typeof telegramCfg?.streaming === "boolean") return telegramCfg.streaming ? "partial" : "off";
	const raw = telegramCfg?.streamMode?.trim().toLowerCase();
	if (raw === "off") return "off";
	if (raw === "partial" || raw === "block") return "partial";
	return "off";
}
...
//#endregion
export { parseTelegramTarget as $, hasBotMention as A, resolveSenderAllowMatch as B, buildTelegramGroupPeerId as C, describeReplyTarget as D, buildTypingThreadParams as E, resolveTelegramReplyId as F, readChannelAllowFromStore as G, isSenderIdAllowed as H, resolveTelegramStreamMode as I, upsertChannelPairingRequest as J, readChannelAllowFromStoreSync as K, resolveTelegramThreadSpec as L, resolveTelegramForumThreadId as M, resolveTelegramGroupAllowFromContext as N, expandTextLinks as O, resolveTelegramMediaPlaceholder as P, isVoiceCompatibleAudio as Q, isSenderAllowed as R, buildTelegramGroupFrom as S, buildTelegramThreadParams as T, mergeAllowFromSources as U, firstDefined as V, addChannelAllowFromStoreEntry as W, listPairingChannels as X, getPairingAdapter as Y, withTelegramApiErrorLogging as Z, resolveTelegramFetch as _, reactMessageTelegram as a, buildSenderLabel as b, sendStickerTelegram as c, wasSentByBot as d, resolveTelegramTargetChatType as et, isRecoverableTelegramNetworkError as f, wrapFileReferencesInHtml as g, renderTelegramHtmlText as h, editMessageTelegram as i, writeJsonFileAtomically as it, normalizeForwardedContext as j, extractTelegramLocation as k, send_exports as l, markdownToTelegramHtml as m, createForumTopicTelegram as n, toLocationContext as nt, sendMessageTelegram as o, markdownToTelegramChunks as p, removeChannelAllowFromStoreEntry as q, deleteMessageTelegram as r, readJsonFileWithFallback as rt, sendPollTelegram as s, buildInlineKeyboard as t, formatLocationText as tt, resolveTelegramVoiceSend as u, splitTelegramCaption as v, buildTelegramParentPeer as w, buildSenderName as x, buildGroupLabel as y, normalizeAllowFromWithStore as z };