...
import { D as resolveDefaultAgentWorkspaceDir, a as resolveAgentModelFallbacksOverride, c as resolveAgentWorkspaceDir, i as resolveAgentDir, l as resolveDefaultAgentId, o as resolveAgentModelPrimary } from "./agent-scope-DhajVyRS.js";
import { t as ensurePiAuthJsonFromAuthProfiles } from "./pi-auth-json-BnX14koJ.js";
...
import { en as loadProviderUsageSummary, fn as maskApiKey, hn as formatRemainingShort, mn as buildAuthHealthSummary, mt as describeFailoverError, nn as formatUsageWindowSummary, pn as DEFAULT_OAUTH_WARN_MS, rn as resolveUsageProviderId, s as runEmbeddedPiAgent } from "./subagent-registry-BDJet-Vq.js";
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-DNdWAq7b.js";
import { t as ensureOpenClawModelsJson } from "./models-config-xdiIJ--F.js";
import { n as loadModelCatalog } from "./model-catalog-DPgNYd7O.js";
import { r as withProgressTotals } from "./progress-BAHiAaDW.js";
import { f as openUrl } from "./onboard-helpers-BE4hqP_a.js";
...
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-Bv6z_9LH.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./config-DMW11Vgn.js").then((n) => n.t);
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-ChKLb_d2.js").then((n) => n.t);
