import { Ft as resolveOpenClawAgentDir } from "./model-selection-mHHEzs4Y.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-4uUnLc3n.js").then((n) => n.r);
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-DkvMcA8I.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
