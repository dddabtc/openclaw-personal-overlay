...
import { Cn as splitShellArgs, H as loadConfig, pt as parseDurationMs } from "./auth-profiles-B1GaQT5q.js";
...
import { d as listMemoryFiles, f as normalizeExtraMemoryPaths } from "./sqlite-BcNj0Ip5.js";
import { r as getMemoryCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-GGw5yqsw.js";
...
function loadManagerRuntime() {
	managerRuntimePromise ??= import("./manager-runtime-jIMyOJ4h.js");
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-gVzo3-tq.js");
