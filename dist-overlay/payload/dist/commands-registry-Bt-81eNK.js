...
import { E as getActivePluginRegistry } from "./subsystem-Bqlcd6-a.js";
import { Qt as DEFAULT_PROVIDER, Zt as DEFAULT_MODEL, m as resolveConfiguredModelRef } from "./model-selection-BnthIvhe.js";
import { n as listChannelDocks } from "./dock-BAyVFjoI.js";
import { t as isCommandFlagEnabled } from "./commands-9uaOLyoy.js";
...
function buildChatCommands() {
	const commands = [
		...
		defineChatCommand({
			...
			args: [{
				name: "action",
				description: "spawn | cancel | steer | close | sessions | status | set-mode | set | cwd | permissions | timeout | model | reset-options | doctor | install | help",
				type: "string",
				choices: [
					"spawn",
					"cancel",
