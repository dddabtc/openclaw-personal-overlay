...
import { p as restoreTerminalState } from "./subsystem-Cf9yS0UI.js";
import "./boolean-DTgd5CzD.js";
import "./auth-profiles-B1GaQT5q.js";
import { r as resolveCliName, t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { v as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-Da1EU5GK.js";
...
import { b as waitForGatewayReachable, f as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, m as probeGatewayReachable, o as formatControlUiSshHint } from "./onboard-helpers-IxvJd8Hl.js";
...
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DCPHzLTW.js";
import { t as resolveOnboardingSecretInputString } from "./onboarding.secret-input-BBAQWrr0.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-BILIB5IL.js").then((n) => n.r);
	...
	if (webSearchProvider) {
		const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DEbKvd5K.js");
		...
		const { SEARCH_PROVIDER_OPTIONS, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DEbKvd5K.js");
