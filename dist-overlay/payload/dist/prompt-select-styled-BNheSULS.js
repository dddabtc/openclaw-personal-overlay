import { At as getResolvedLoggerSettings, Pt as CONFIG_PATH, Ut as resolveGatewayPort, Wt as resolveIsNixMode, Yt as resolveStateDir, _ as defaultRuntime, lt as shortenHomePath, n as isTruthyEnvValue, ot as resolveUserPath, pn as resolveRequiredHomeDir, qt as resolveOAuthDir, ut as sleep } from "./entry.js";
import { Gt as CLAUDE_CLI_PROFILE_ID, Ht as DEFAULT_MODEL, Kt as CODEX_CLI_PROFILE_ID, N as getModelRefStatus, S as updateAuthProfileStoreWithLock, U as resolveHooksGmailModel, Ut as DEFAULT_PROVIDER, V as resolveConfiguredModelRef, b as ensureAuthProfileStore, c as resolveApiKeyForProfile, p as repairOAuthProfileIdMismatch, s as resolveProfileUnusableUntilForDisplay, xt as resolveApiKeyForProvider } from "./auth-profiles-C7RTY9Sv.js";
...
import { c as resolveAgentWorkspaceDir, i as resolveAgentDir, l as resolveDefaultAgentId, p as DEFAULT_AGENTS_FILENAME } from "./agent-scope-DhajVyRS.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BajsVtLY.js";
import { l as writeConfigFile, o as readConfigFileSnapshot } from "./config-BBNa7O_8.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-DMOW0wPs.js";
import { l as resolveGatewayBindHost, n as isLoopbackHost } from "./net-DZ5Ayk-W.js";
import { g as loadOpenClawPlugins, hn as formatRemainingShort, mn as buildAuthHealthSummary, pn as DEFAULT_OAUTH_WARN_MS } from "./subagent-registry-Cc0kGCxw.js";
import { F as resolveMainSessionKey, H as cleanStaleLockFiles, o as loadSessionStore } from "./sessions-BfWM-oFg.js";
import { n as listChannelPlugins } from "./plugins-Dhh2a3qc.js";
import { D as DEFAULT_SANDBOX_COMMON_IMAGE, E as DEFAULT_SANDBOX_BROWSER_IMAGE, O as DEFAULT_SANDBOX_IMAGE, p as resolveSandboxScope } from "./sandbox-D-5UkuzR.js";
import { a as resolveGatewayAuth } from "./auth-BcWLEKcS.js";
import { a as formatPortDiagnostics, n as inspectPortUsage } from "./ports-CjVslX4J.js";
...
import { i as resolveMemoryBackendConfig } from "./memory-cli-0uYtPYU9.js";
...
import { c as resolveGatewayLaunchAgentLabel, d as resolveGatewaySystemdServiceName, f as resolveGatewayWindowsTaskName, m as resolveNodeLaunchAgentLabel } from "./constants-YI1d6slK.js";
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-VhYln9Mp.js";
import { n as isWSLEnv, t as isWSL } from "./wsl-jdLWdiKy.js";
...
import { t as collectChannelStatusIssues } from "./channels-status-issues-CmHZBwQD.js";
import { a as gatewayInstallErrorHint, f as renderSystemNodeWarning, i as buildGatewayInstallPlan, m as resolveSystemNodeInfo, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-yGnZwmEI.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-BrybH4HV.js";
import { a as launchAgentPlistExists, i as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as isLaunchAgentListed, s as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-DcFI40_W.js";
import { i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as formatRuntimeStatus, t as isSystemdUnavailableDetail } from "./systemd-hints-Cd-yRMdt.js";
...
import { t as resolveDmAllowState } from "./dm-policy-shared-CEPMcdGF.js";
...
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-B56YiWzx.js";
...
import { n as doctorShellCompletion } from "./doctor-completion-DWoA8Suu.js";
