...
import { h as pathExists, y as resolveUserPath } from "./utils-BvKkAKT3.js";
import "./thinking-EAliFiVK.js";
import "./reply-CAdc-L3v.js";
import { v as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-D8gw-U5c.js";
import { p as restoreTerminalState } from "./subsystem-Bqlcd6-a.js";
...
import { b as waitForGatewayReachable, f as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, m as probeGatewayReachable, o as formatControlUiSshHint } from "./onboard-helpers-CikULQa1.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-C0AvmGRP.js").then((n) => n.r);
