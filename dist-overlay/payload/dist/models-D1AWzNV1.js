...
import { $t as formatUsageWindowSummary, Bt as DEFAULT_OAUTH_WARN_MS, Ht as formatRemainingShort, Rr as resolveModelWithRegistry, Vt as buildAuthHealthSummary, Zt as loadProviderUsageSummary, en as resolveUsageProviderId, er as runEmbeddedPiAgent, mr as describeFailoverError, zt as maskApiKey } from "./compact-BqDZMSaR.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-Df9KKkbT.js";
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-BCX3TKIK.js";
import { t as ensureOpenClawModelsJson } from "./models-config-BV1AjiaC.js";
import { n as loadModelCatalog } from "./model-catalog-BDt4wryO.js";
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-CiBVZbcI.js";
...
import { a as formatMs, c as loadValidConfigOrThrow, d as resolveKnownAgentId, f as resolveModelKeysFromEntries, i as ensureFlagCompatibility, l as mergePrimaryFallbackConfig, m as updateConfig, n as applyOpenAICodexModelDefault, o as formatTokenK, p as resolveModelTarget, r as applyDefaultModelPrimaryUpdate, s as isLocalBaseUrl, t as OPENAI_CODEX_DEFAULT_MODEL, u as normalizeAlias } from "./openai-codex-model-default-BB8qzz-0.js";
import { Ct as writeOAuthCredentials, d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-DuQKyPmL.js";
import { n as logConfigUpdated } from "./logging-BfIBddi5.js";
import { a as loginOpenAICodexOAuth, c as resolvePluginProviders, i as resolveProviderMatch, n as mergeConfigPatch, o as createVpsAwareOAuthHandlers, r as pickAuthMethod, s as isRemoteEnvironment, t as applyDefaultModel } from "./provider-auth-helpers-CQirddUL.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles-D6r73dBV.js").then((n) => n.t);
