import { Dt as theme, _ as defaultRuntime, lt as shortenHomePath, ot as resolveUserPath } from "./entry.js";
...
import { t as buildGatewayConnectionDetails } from "./call-DMOW0wPs.js";
...
import { t as DANGEROUS_ACP_TOOLS } from "./dangerous-tools-B8QrxStA.js";
import { t as isMainModule } from "./is-main-BG2RT3Fv.js";
...
function escapeInlineControlChars(value) {
	return value.replaceAll("\0", "\\0").replace(/[\r\n\t\v\f\u2028\u2029]/g, (char) => {
		switch (char) {
			case "\r": return "\\r";
			case "\n": return "\\n";
			case "	": return "\\t";
