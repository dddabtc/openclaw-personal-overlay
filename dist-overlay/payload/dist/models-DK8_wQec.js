...
import { Bt as DEFAULT_OAUTH_WARN_MS, Ht as formatRemainingShort, Qt as resolveUsageProviderId, Rr as resolveModelWithRegistry, Vt as buildAuthHealthSummary, Yt as loadProviderUsageSummary, Zt as formatUsageWindowSummary, er as runEmbeddedPiAgent, mr as describeFailoverError, zt as maskApiKey } from "./compact-CS06HDux.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-B5Wxu5WT.js";
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-BCX3TKIK.js";
import { t as ensureOpenClawModelsJson } from "./models-config-DyTiDfSK.js";
import { n as loadModelCatalog } from "./model-catalog-J9c2RT3Q.js";
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-CdR558gG.js";
import { f as openUrl } from "./onboard-helpers-BDLlOeFG.js";
...
import { a as formatMs, c as loadValidConfigOrThrow, d as resolveKnownAgentId, f as resolveModelKeysFromEntries, i as ensureFlagCompatibility, l as mergePrimaryFallbackConfig, m as updateConfig, n as applyOpenAICodexModelDefault, o as formatTokenK, p as resolveModelTarget, r as applyDefaultModelPrimaryUpdate, s as isLocalBaseUrl, t as OPENAI_CODEX_DEFAULT_MODEL, u as normalizeAlias } from "./openai-codex-model-default-BvMeiwX2.js";
import { Ct as writeOAuthCredentials, d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-BoMAjaLw.js";
import { n as logConfigUpdated } from "./logging-BfIBddi5.js";
import { a as loginOpenAICodexOAuth, c as resolvePluginProviders, i as resolveProviderMatch, n as mergeConfigPatch, o as createVpsAwareOAuthHandlers, r as pickAuthMethod, s as isRemoteEnvironment, t as applyDefaultModel } from "./provider-auth-helpers-CndutDyR.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles-Dfz0edQp.js").then((n) => n.t);
