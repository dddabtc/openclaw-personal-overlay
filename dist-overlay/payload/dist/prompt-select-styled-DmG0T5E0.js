...
import { a as resolveAgentDir, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, u as resolveAgentWorkspaceDir } from "./agent-scope-Da1EU5GK.js";
...
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-CUd_d2ed.js";
...
import { Bt as DEFAULT_OAUTH_WARN_MS, Ht as formatRemainingShort, Sr as resolveBootstrapContextForRun, Vt as buildAuthHealthSummary, c as loadOpenClawPlugins, dr as analyzeBootstrapBudget, fr as buildBootstrapInjectionStats, gr as resolveAgentSessionDirs } from "./compact-DgmWC38G.js";
import { n as listChannelPlugins } from "./plugins-BVlyTb8F.js";
import { B as resolveBootstrapTotalMaxChars, R as resolveBootstrapMaxChars } from "./pi-embedded-helpers-BB2LNFoT.js";
import { E as DEFAULT_SANDBOX_BROWSER_IMAGE, O as DEFAULT_SANDBOX_IMAGE, p as resolveSandboxScope } from "./sandbox-oZkjnD_W.js";
import { d as resolveGatewayBindHost, i as isLoopbackHost } from "./ws-Z0GdyNOg.js";
import { a as resolveGatewayAuth } from "./auth-DdEjESsp.js";
import { o as readGatewayTokenEnv } from "./credentials-BmtdMaC0.js";
import { n as hasAmbiguousGatewayAuthModeConfig } from "./auth-mode-policy-BSzjfW8d.js";
import { n as resolveConfiguredSecretInputWithFallback } from "./resolve-configured-secret-input-string-Cjny1Pmf.js";
import { n as inspectPortUsage, o as formatPortDiagnostics } from "./ports-CTMzENnh.js";
import { at as formatSessionArchiveTimestamp, et as resolveMainSessionKey, ot as isPrimarySessionTranscriptFileName, s as loadSessionStore, ut as cleanStaleLockFiles } from "./sessions-KF02xeDF.js";
...
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-qPAXM4nu.js";
import { l as resolveDmAllowState } from "./pi-tools.policy-jZh0ZTnY.js";
...
import { r as isWSLEnv, t as isWSL } from "./wsl-MgD4AnRZ.js";
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-IxvJd8Hl.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-Bcr283QM.js";
import { i as resolveMemoryBackendConfig } from "./memory-cli-DIzu0MFF.js";
import { i as resolveMemorySearchConfig, r as hasConfiguredMemorySecretInput } from "./manager-BF-TaQjb.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DWGtJW56.js";
import { t as note$1 } from "./note-DITQCNUf.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-BZD5Au0A.js";
import { a as renderSystemNodeWarning, o as resolveSystemNodeInfo } from "./daemon-install-plan.shared-R7ybKms3.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint, t as resolveGatewayInstallToken } from "./gateway-install-token-BZGlXV_-.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-BSeNz-AR.js";
import { i as isSystemdUserServiceAvailable, u as uninstallLegacySystemdUnits } from "./systemd-BNyLm-o_.js";
import { a as launchAgentPlistExists, i as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as isLaunchAgentListed, t as resolveGatewayService } from "./service-siGlG0bf.js";
import { c as buildPlatformRuntimeLogHints, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as readEmbeddedGatewayToken, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-BNNMjMsY.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-B1UVlXtF.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-CVL55s8B.js";
import { r as healthCommand } from "./health-BjWu_4rN.js";
import { n as resolveControlUiDistIndexHealth, r as resolveControlUiDistIndexPathForRoot } from "./control-ui-assets-DCPHzLTW.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-CG7xZcfr.js";
...
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-Bi8w-aKI.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-BILIB5IL.js";
import { t as formatHealthCheckFailure } from "./health-format-CSNUS7OB.js";
import { n as doctorShellCompletion } from "./doctor-completion-HtA2Npr0.js";
