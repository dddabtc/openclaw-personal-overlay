import { h as resolveAgentModelPrimaryValue, m as resolveAgentModelFallbackValues } from "./agent-scope-DfPRIj4l.js";
import { $ as shouldLogVerbose, X as logVerbose, t as createSubsystemLogger, ut as resolvePreferredOpenClawTmpDir } from "./subsystem-gWhP9HUz.js";
import { _ as runExec } from "./workspace-CoXkK9vh.js";
import { E as resolveApiKeyForProvider, T as requireApiKey, X as resolveOpenClawAgentDir, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-DzQXaRi3.js";
import { t as normalizeChatType } from "./chat-type-C4pAlbsI.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-aD0BGevY.js";
import { d as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, f as isInboundPathAllowed, m as resolveIMessageAttachmentRoots, n as loadConfig, p as mergeInboundPathRoots } from "./config-DPEn0sA9.js";
import { t as describeImageWithModel, w as ensureOpenClawModelsJson } from "./image-CzHSa-_X.js";
import { n as collectProviderApiKeysForExecution, r as executeWithApiKeyRotation, t as parseGeminiAuth } from "./gemini-auth-RlLwqORB.js";
import { n as fetchWithTimeout } from "./fetch-timeout-KCB40cfA.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-B6nV3reU.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-CFUHsj1i.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-D3ju-zRP.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
