...
import { B as theme, D as isPlainObject, E as truncateUtf16Safe, H as getLogger, M as logVerbose, P as setVerbose, R as colorize, S as shortenHomePath, U as getResolvedLoggerSettings, V as getChildLogger, c as ensureDir, r as clamp, y as resolveUserPath, z as isRich } from "./utils-BvKkAKT3.js";
...
import { $ as stripLegacyDeliveryFields, $n as resolveTtsApiKey, $t as lookupContextTokens, A as markGatewaySigusr1RestartHandled, An as formatZonedTimestamp, At as computeBackoff, B as writeRestartSentinel, Bn as resolveAnnounceTargetFromKey, Br as DEFAULT_INPUT_TIMEOUT_MS, Bt as resolveSessionDeliveryTarget, Cn as createReplyDispatcher, Cr as enqueueSystemEvent, D as deferGatewayRestartUntilIdle, Dr as requestHeartbeatNow, Dt as handleSlackHttpRequest, E as consumeGatewaySigusr1RestartAuthorization, F as formatDoctorNonInteractiveHint, Fn as countActiveDescendantRuns, Fr as normalizeSendPolicy, Ft as resolveAgentDeliveryPlan, G as normalizeOptionalAgentId, Gn as getAgentRunContext, Gr as resolveAgentTimeoutMs, Gt as createDefaultDeps, H as normalizeCronJobCreate, Hn as clearSessionQueues, Hr as extractImageContentFromSource, Ht as createOutboundSendDeps, I as formatRestartSentinelMessage, In as initSubagentRegistry, Ir as resolveSendPolicy, It as resolveAgentOutboundTarget, J as normalizePayloadToSystemText, Jn as resolveUserTimezone, Jt as getCliSessionId, K as normalizeOptionalSessionKey, Kn as onAgentEvent, Kt as createOutboundSendDeps$1, Ln as listDescendantRunsForRequester, Lr as DEFAULT_INPUT_IMAGE_MAX_BYTES, M as setGatewaySigusr1RestartPolicy, Mr as ACP_SESSION_IDENTITY_RENDERER_VERSION, N as setPreRestartDeferralCheck, Nn as isAbortRequestText, Nr as getAcpSessionManager, Nt as agentCommand, O as emitGatewayRestart, Ot as readJsonBodyWithLimit, P as consumeRestartSentinel, Pn as stopSubagentsForRequester, Pr as resolveAgentSessionDirs, Q as hasLegacyDeliveryHints, Qn as isTtsProviderConfigured, Qt as applyModelOverrideToSessionEntry, R as summarizeRestartSentinel, Rr as DEFAULT_INPUT_IMAGE_MIMES, S as resolveOutboundSessionRoute, Sn as dispatchInboundMessage, U as normalizeCronJobPatch, Un as clearAgentRunContext, Ur as normalizeMimeList, Ut as applyVerboseOverride, V as normalizeHttpWebhookUrl, Vn as readLatestAssistantReply, Vr as extractFileContentFromSource, Vt as resolveOutboundChannelPlugin, W as inferLegacyName, Wn as emitAgentEvent, Wr as resolveInputFileLimits, Wt as parseVerboseOverride, X as migrateLegacyCronPayload, Xn as getTtsProvider, Xt as runCliAgent, Y as normalizeRequiredName, Yn as clearBootstrapSnapshot, Yt as setCliSessionId, Z as buildDeliveryFromLegacyPayload, Zn as isTtsEnabled, _ as buildDefaultToolPolicyPipelineSteps, _t as resolveSessionModelRef, ar as setTtsProvider, at as resolvePluginTools, br as stripHeartbeatToken, cn as getHookType, cr as OPENAI_TTS_VOICES, dr as getTotalQueueSize, dt as listAgentsForGateway, er as resolveTtsAutoMode, f as runEmbeddedPiAgent, fr as resetAllLanes, ft as listSessionsFromStore, g as applyToolPolicyPipeline, gr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, gt as resolveGatewaySessionStoreTarget, h as waitForEmbeddedPiRunEnd, hr as CommandLane, ht as pruneLegacyStoreKeys, i as resolveCronStyleNow, ir as setTtsEnabled, it as getPluginToolMeta, j as scheduleGatewaySigusr1Restart, jt as sleepWithAbort, k as isGatewaySigusr1RestartExternallyAllowed, kt as requestBodyErrorToText, ln as isExternalHookSession, lr as getActiveTaskCount, lt as canonicalizeSpawnedByForAgent, m as getActiveEmbeddedRunCount, mn as buildHistoryContextFromEntries, mr as waitForActiveTasks, mt as loadSessionEntry, n as BARE_SESSION_RESET_PROMPT, nn as resolveAgentAvatar, nr as resolveTtsPrefsPath, nt as applyBrowserProxyPaths, on as buildSafeExternalPrompt, or as textToSpeech, p as abortEmbeddedPiRun, pr as setCommandLaneConcurrency, pt as loadCombinedSessionStoreForGateway, q as normalizeOptionalText, qn as registerAgentRunContext, qt as runWithModelFallback, rr as resolveTtsProviderOrder, rt as persistBrowserProxyFiles, sn as detectSuspiciousPatterns, sr as OPENAI_TTS_MODELS, st as loadOpenClawPlugins, tn as resolveSessionAuthProfileOverride, tr as resolveTtsConfig, un as unbindThreadBindingsBySessionKey, vt as openVerifiedFileSync, w as resetDirectoryCache, wn as getTotalPendingReplies, wr as isSystemEventContextChanged, x as ensureOutboundSessionEntry, xt as loadProviderUsageSummary, y as createOpenClawTools, yt as normalizeGroupActivation, zn as runSubagentAnnounceFlow, zr as DEFAULT_INPUT_MAX_REDIRECTS, zt as resolveOutboundTarget } from "./reply-CAdc-L3v.js";
import { A as resolveDefaultAgentWorkspaceDir, C as DEFAULT_SOUL_FILENAME, E as ensureAgentWorkspace, O as isWorkspaceOnboardingCompleted, S as DEFAULT_MEMORY_FILENAME, T as DEFAULT_USER_FILENAME, a as resolveAgentDir, b as DEFAULT_IDENTITY_FILENAME, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, i as resolveAgentConfig, j as resolveWorkspaceTemplateDir, l as resolveAgentSkillsFilter, m as resolveSessionAgentId, n as listAgentEntries, r as listAgentIds, u as resolveAgentWorkspaceDir, v as DEFAULT_BOOTSTRAP_FILENAME, w as DEFAULT_TOOLS_FILENAME, x as DEFAULT_MEMORY_ALT_FILENAME, y as DEFAULT_HEARTBEAT_FILENAME } from "./agent-scope-D8gw-U5c.js";
import { A as createEmptyPluginRegistry, B as registerInternalHook, E as getActivePluginRegistry, R as clearInternalHooks, V as triggerInternalHook, _ as CHANNEL_IDS, a as setConsoleSubsystemFilter, f as defaultRuntime, n as runtimeForLogger, o as setConsoleTimestampPrefix, t as createSubsystemLogger, z as createInternalHookEvent } from "./subsystem-Bqlcd6-a.js";
...
import { i as logDebug, n as runExec, s as logWarn, t as runCommandWithTimeout } from "./exec-CAIB93jD.js";
import { Ht as isPidAlive, Qt as DEFAULT_PROVIDER, Wt as normalizeSecretInput, Xt as DEFAULT_CONTEXT_TOKENS, Zt as DEFAULT_MODEL, a as getModelRefStatus, f as resolveAllowedModelRef, g as resolveHooksGmailModel, h as resolveDefaultModelForAgent, m as resolveConfiguredModelRef, s as isCliProvider, t as buildAllowedModelSet, x as resolveThinkingDefault, y as resolveSubagentConfiguredModelSelection } from "./model-selection-BnthIvhe.js";
import "./github-copilot-token-nncItI8D.js";
import { t as formatCliCommand } from "./command-format-ChfKqObn.js";
import "./boolean-BgXe2hyu.js";
import { n as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-SxoKgHK1.js";
import "./host-env-security-ljCLeQmh.js";
import { _ as normalizeGatewayClientMode, f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-CmNH1i-8.js";
import "./send-CJJkybpI.js";
import { A as isAvatarImageDataUrl, At as resolveAgentMaxConcurrent, D as AVATAR_MAX_BYTES, E as parseByteSize, Ot as buildTalkConfigResponse, P as looksLikeAvatarPath, T as parseDurationMs, a as parseConfigJson5, c as resolveConfigSnapshotHash, d as OpenClawSchema, i as loadConfig, jt as resolveSubagentMaxConcurrent, k as isAvatarHttpUrl, l as writeConfigFile, n as migrateLegacyConfig, o as readConfigFileSnapshot, r as createConfigIO, s as readConfigFileSnapshotForWrite, u as validateConfigObjectWithPlugins, vt as applyMergePatch, yt as applyLegacyMigrations } from "./config-Ca77L3N1.js";
...
import { l as isTestDefaultMemorySlotDisabled } from "./manifest-registry-L8eulu9n.js";
import "./dock-BAyVFjoI.js";
import { d as registerUnhandledRejectionHandler } from "./runner-C_PvE9PO.js";
import { x as extractTextFromChatContent } from "./image-1YtPREVu.js";
import "./models-config-DYcXOndH.js";
import "./pi-model-discovery-Bakt-Qrp.js";
import "./pi-embedded-helpers-IykXeTcj.js";
import { C as resolveToolProfilePolicy, _ as collectExplicitAllowlist, y as mergeAlsoAllowPolicy } from "./sandbox-DRVWt7n5.js";
...
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-Cu00fx92.js";
import { t as safeEqualSecret } from "./secret-equal-D6AoXne1.js";
import "./ip-D6hQ9Srg.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-QICRxDwG.js";
import { c as normalizeHostHeader, d as resolveGatewayBindHost, f as resolveGatewayListenHosts, i as isLoopbackHost, l as pickPrimaryLanIPv4, n as isLocalishHost, o as isTrustedProxyAddress, p as resolveHostName, r as isLoopbackAddress, s as isValidIPv4, t as rawDataToString, u as resolveClientIp } from "./ws-D1QB-fai.js";
import { a as resolveGatewayAuth, c as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, i as isLocalDirectRequest, l as createAuthRateLimiter, n as authorizeHttpGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, r as authorizeWsControlUiGatewayConnect, s as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, t as assertGatewayAuthConfigured, u as normalizeRateLimitClientIp } from "./auth-Bxx2VNC9.js";
import { c as ensureGatewayStartupAuth, l as mergeGatewayTailscaleConfig } from "./server-context-GXNpKSjl.js";
import { d as hasBinary } from "./frontmatter-DR47FZL2.js";
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-7LoesrWg.js";
import { n as isPathInside, t as isNotFoundPathError } from "./path-guards-CejwTirm.js";
import { i as compileSafeRegex } from "./redact-FwcF9gh5.js";
import { a as isErrno, n as formatErrorMessage } from "./errors-B4zBevhh.js";
...
import { a as ToolInputError } from "./target-errors-jXAHWg-v.js";
import "./diagnostic-session-state-BCQ_xRK9.js";
import { a as createBrowserControlContext, i as createBrowserRouteDispatcher, o as startBrowserControlServiceFromConfig, r as resolveSystemRunCommand, s as getMachineDisplayName } from "./with-timeout-COTLVL3m.js";
import { d as startDiagnosticHeartbeat, f as stopDiagnosticHeartbeat, m as isDiagnosticsEnabled } from "./diagnostic-m-UmrLXR.js";
import { d as loadCronStore, f as resolveCronStorePath, p as saveCronStore } from "./send-DcUBeURH.js";
import "./model-C661P9bx.js";
import { a as resolveAgentIdentity, t as createReplyPrefixOptions } from "./reply-prefix-aUp4d71G.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-B27KJ7Cv.js";
import { n as resolveMemorySearchConfig } from "./manager-BSvdNkTL.js";
...
import { t as getChannelActivity } from "./channel-activity-CiJA_kZs.js";
...
import { t as formatHelpExamples } from "./help-format-CMbyj-cx.js";
import { n as withProgress } from "./progress-Dc2O5riR.js";
import "./resolve-route-DtjSBRbY.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-BWO37HqM.js";
import "./replies-D4sn5dAB.js";
import { S as registerSkillsChangeListener, _ as requestNodePairing, c as recordRemoteNodeInfo, d as removeRemoteNodeInfo, f as setSkillsRemoteRegistry, g as renamePairedNode, h as rejectNodePairing, l as refreshRemoteBinsForConnectedNodes, m as listNodePairing, o as getRemoteSkillEligibility, p as approveNodePairing, s as primeRemoteSkillsCache, u as refreshRemoteNodeBins, v as updatePairedNodeMetadata, x as getSkillsSnapshotVersion, y as verifyNodeToken } from "./skill-commands-ypBUxOb0.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-u6swlofe.js";
import { i as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-rIpFqItI.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-DuYHEOEs.js";
...
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-CikULQa1.js";
...
import { t as ensureOpenClawCliOnPath } from "./path-env-oaLXdtbY.js";
import "./runtime-guard-Bnl_480k.js";
import { t as forceFreePortAndWait } from "./ports-CnB7Ylfv.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-GSAsQ5rh.js";
...
import { t as WizardCancelledError } from "./prompts-BKv7CYJz.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-BJkttj_S.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-CukbfIgZ.js";
import { t as isWithinDir } from "./path-safety-Dz_Ym5YC.js";
...
import "./channels-status-issues-ZovjcZoT.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-DjBC_evI.js";
import "./daemon-install-helpers-BtR3mWNL.js";
import "./systemd-PvvLtS5M.js";
import "./service-CqSm03tE.js";
import "./lifecycle-core-1p5Z8xVm.js";
import "./systemd-hints-C_RdDOG0.js";
import { t as parsePort$1 } from "./parse-port-e2GZqX81.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-CI17cxhG.js";
import "./diagnostics-gqZ1BNJG.js";
import "./table-DO7pyEcL.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-NUNG8EW1.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-BBPieT9u.js";
import { c as resolveNodeCommandAllowlist, l as probeGateway, n as collectEnabledInsecureOrDangerousFlags, s as isNodeCommandAllowed } from "./audit-DPyjSM7v.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-CHrrh4sD.js";
import { n as getStatusSummary, r as pickGatewaySelfPresence } from "./status-Cr47TLR6.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-BsLz_suh.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-CKhV7pYG.js";
import { h as normalizeUpdateChannel, l as DEFAULT_PACKAGE_CHANNEL, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-D4QsWVOS.js";
import { t as runOnboardingWizard } from "./onboarding-tXyCvhVs.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-20LGDe6F.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-ClvpN_Rf.js";
import "./node-service-DBsV8XrS.js";
import "./status.update-BpZixxbX.js";
import { t as installSkill } from "./skills-install-BMiowytD.js";
import { t as runGatewayUpdate } from "./update-runner-CzNnNeno.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-4GKVZfJV.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BYWyP5KC.js");
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-R6vkBuuw.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		...
		const { deliverOutboundPayloads } = await import("./deliver-BLwJiE1C.js").then((n) => n.n);
