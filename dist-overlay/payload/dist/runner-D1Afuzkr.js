import { h as resolveAgentModelPrimaryValue, m as resolveAgentModelFallbackValues } from "./agent-scope-DBH4tc6E.js";
import { $ as shouldLogVerbose, X as logVerbose, t as createSubsystemLogger, ut as resolvePreferredOpenClawTmpDir } from "./subsystem-DhjIxims.js";
import { _ as runExec } from "./workspace-jH04VzX-.js";
import { E as resolveApiKeyForProvider, T as requireApiKey, X as resolveOpenClawAgentDir, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-w6ucPeWO.js";
import { t as normalizeChatType } from "./chat-type-C4pAlbsI.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-BhxPhYFk.js";
import { d as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, f as isInboundPathAllowed, m as resolveIMessageAttachmentRoots, n as loadConfig, p as mergeInboundPathRoots } from "./config-CyPYPMkz.js";
import { t as describeImageWithModel, w as ensureOpenClawModelsJson } from "./image-EizydwYA.js";
import { n as collectProviderApiKeysForExecution, r as executeWithApiKeyRotation, t as parseGeminiAuth } from "./gemini-auth-BSk0KCpC.js";
import { n as fetchWithTimeout } from "./fetch-timeout-KCB40cfA.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-BYswKNH0.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-BqL3X_i0.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-jBfzZ1KG.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
