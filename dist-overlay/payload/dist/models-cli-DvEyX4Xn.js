...
import { T as parseDurationMs, i as loadConfig } from "./config-Ca77L3N1.js";
...
import { t as ensureOpenClawModelsJson } from "./models-config-DYcXOndH.js";
...
import { r as resolveForwardCompatModel } from "./model-C661P9bx.js";
import { t as ensurePiAuthJsonFromAuthProfiles } from "./model-D3NcLY9o.js";
...
import { r as withProgressTotals } from "./progress-Dc2O5riR.js";
...
import { f as openUrl } from "./onboard-helpers-CikULQa1.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-DXoiRDPI.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-BZfIT2dc.js";
import { n as logConfigUpdated } from "./logging-DF6cwEL1.js";
import { a as createVpsAwareOAuthHandlers, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-Dg56c_rA.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./config-Ca77L3N1.js").then((n) => n.t);
	const { ensureAuthProfileStore } = await import("./model-selection-BnthIvhe.js").then((n) => n.mt);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-D3NcLY9o.js");
