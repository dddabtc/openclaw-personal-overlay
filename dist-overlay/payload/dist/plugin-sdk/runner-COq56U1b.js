import { S as resolveIMessageAttachmentRoots, b as isInboundPathAllowed, n as loadConfig, x as mergeInboundPathRoots, y as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS } from "./config-CGGh37TZ.js";
import { $ as logVerbose, mt as resolvePreferredOpenClawTmpDir, nt as shouldLogVerbose, t as createSubsystemLogger } from "./subsystem-BaHMxILP.js";
import { E as resolveApiKeyForProvider, H as resolveOpenClawAgentDir, T as requireApiKey, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-Ci8st5Hn.js";
import { D as runExec, F as resolveAgentModelPrimaryValue, P as resolveAgentModelFallbackValues } from "./agent-scope-Dse8uqIv.js";
import { t as normalizeChatType } from "./chat-type-C4pAlbsI.js";
import { n as fetchWithTimeout } from "./fetch-timeout-DTIN7CGM.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-CrkHe2yG.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-DrdTzp-o.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-CbvahFFG.js";
import { C as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-Crjr5H8G.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-B7hXZDq4.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-BnJij3aq.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
