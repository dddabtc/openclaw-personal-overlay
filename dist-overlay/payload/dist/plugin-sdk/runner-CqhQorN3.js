import { S as resolveIMessageAttachmentRoots, b as isInboundPathAllowed, n as loadConfig, x as mergeInboundPathRoots, y as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS } from "./config-mFX4iXuS.js";
import { $ as logVerbose, mt as resolvePreferredOpenClawTmpDir, nt as shouldLogVerbose, t as createSubsystemLogger } from "./subsystem-wfAzEN3T.js";
import { E as resolveApiKeyForProvider, H as resolveOpenClawAgentDir, T as requireApiKey, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-DIuDAWoy.js";
import { D as runExec, F as resolveAgentModelPrimaryValue, P as resolveAgentModelFallbackValues } from "./agent-scope-LnIU4huW.js";
import { t as normalizeChatType } from "./chat-type-C4pAlbsI.js";
import { n as fetchWithTimeout } from "./fetch-timeout-DTIN7CGM.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-DkUrLYnc.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-2oY0g5rK.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-CpK_t8kV.js";
import { C as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-DJBgq6XZ.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-Cn0ZOfDR.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-CIOA3HZE.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
