...
import { n as loadConfig, o as writeConfigFile, t as createConfigIO, z as getBlockedNetworkModeReason } from "./config-mFX4iXuS.js";
import { H as resolveUserPath, Y as truncateUtf16Safe, c as CHANNEL_IDS, i as defaultRuntime, t as createSubsystemLogger } from "./subsystem-wfAzEN3T.js";
import { i as parseBooleanValue, t as formatCliCommand } from "./command-format-CL9J-e-o.js";
import { D as runExec, _ as DEFAULT_IDENTITY_FILENAME, b as DEFAULT_USER_FILENAME, d as resolveSessionAgentId, g as DEFAULT_HEARTBEAT_FILENAME, h as DEFAULT_BOOTSTRAP_FILENAME, m as DEFAULT_AGENT_WORKSPACE_DIR, p as DEFAULT_AGENTS_FILENAME, r as resolveAgentConfig, v as DEFAULT_SOUL_FILENAME, x as ensureAgentWorkspace, y as DEFAULT_TOOLS_FILENAME } from "./agent-scope-LnIU4huW.js";
import { A as acquireSessionWriteLock, H as canonicalizeMainSessionAlias, U as resolveAgentMainSessionKey } from "./sessions-np3z_WgA.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-DNMNty8O.js";
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-DkUrLYnc.js";
import { t as SsrFBlockedError } from "./ssrf-C8mJOpz5.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-yEhdNnT1.js";
import { _ as safeEqualSecret, a as syncSkillsToWorkspace, f as PATH_ALIAS_POLICIES, g as sanitizeEnvVars, l as resolveSandboxInputPath, p as assertNoPathAliasEscape, u as resolveSandboxPath } from "./skills-wKM1hVlb.js";
...
import { i as saveMediaBuffer, t as ensureMediaDir } from "./store-DoxZR3fS.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-BgLIJd4O.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-BgLIJd4O.js")).closePlaywrightBrowserConnection();
		} catch {}
