...
import { E as loadConfig, O as readConfigFileSnapshotForWrite, hn as withFileLock$1, j as writeConfigFile, nn as resolveTelegramPreviewStreamMode, ur as isTruthyEnvValue } from "./model-auth-BTPO3sWW.js";
import { c as resolveTelegramAccount, n as listChannelPlugins, t as getChannelPlugin } from "./plugins-DXyG_9Uo.js";
import { l as hasProxyEnvConfigured } from "./ssrf-W-kPGH2e.js";
import { D as normalizeMimeType, E as kindFromMime, S as getFileExtension, T as isGifMedia } from "./message-channel-zg0WyhVM.js";
import { r as writeJsonAtomic } from "./json-files-D-3S0Vvs.js";
import { _ as loadWebMedia, i as resolveMarkdownTableMode, n as markdownToIR, t as chunkMarkdownIR } from "./ir-BQGV_zsI.js";
...
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-lscsgPVG.js";
...
//#endregion
export { readJsonFileWithFallback as $, extractTelegramLocation as A, resolveTelegramThreadSpec as B, buildTelegramGroupFrom as C, buildTypingThreadParams as D, buildTelegramThreadParams as E, resolveTelegramForumThreadId as F, formatLocationText as G, normalizeAllowFrom as H, resolveTelegramGroupAllowFromContext as I, isVoiceCompatibleAudio as J, toLocationContext as K, resolveTelegramMediaPlaceholder as L, hasBotMention as M, normalizeForwardedContext as N, describeReplyTarget as O, resolveTelegramDirectPeerId as P, upsertChannelPairingRequest as Q, resolveTelegramReplyId as R, buildSenderName as S, buildTelegramParentPeer as T, normalizeDmAllowFromWithStore as U, isSenderAllowed as V, resolveSenderAllowMatch as W, readChannelAllowFromStore as X, addChannelAllowFromStoreEntry as Y, removeChannelAllowFromStoreEntry as Z, wrapFileReferencesInHtml as _, reactMessageTelegram as a, mergeDmAllowFromSources as at, buildGroupLabel as b, sendStickerTelegram as c, resolveCronStorePath as d, writeJsonFileAtomically as et, wasSentByBot as f, renderTelegramHtmlText as g, markdownToTelegramHtml as h, editMessageTelegram as i, isSenderIdAllowed as it, getTelegramTextParts as j, expandTextLinks as k, resolveTelegramVoiceSend as l, markdownToTelegramChunks as m, createForumTopicTelegram as n, listPairingChannels as nt, sendMessageTelegram as o, resolveGroupAllowFromSources as ot, isRecoverableTelegramNetworkError as p, withTelegramApiErrorLogging as q, deleteMessageTelegram as r, firstDefined as rt, sendPollTelegram as s, buildInlineKeyboard as t, getPairingAdapter as tt, loadCronStore as u, resolveTelegramFetch as v, buildTelegramGroupPeerId as w, buildSenderLabel as x, splitTelegramCaption as y, resolveTelegramStreamMode as z };
