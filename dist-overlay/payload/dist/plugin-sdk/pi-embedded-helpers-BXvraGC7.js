...
import { d as getChannelDock, o as normalizeThinkLevel } from "./thinking-gLNjniYP.js";
import { T as normalizeMessageChannel, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, w as listDeliverableMessageChannels } from "./image-ops-C55wv2dT.js";
import { ft as normalizeChatType, r as normalizeChannelId } from "./plugins-CuUAOaQr.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-AX0e_P-L.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-AX0e_P-L.js")).closePlaywrightBrowserConnection();
	} catch {}
}
