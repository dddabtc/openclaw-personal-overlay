import { D as runExec, _ as DEFAULT_IDENTITY_FILENAME, b as DEFAULT_USER_FILENAME, d as resolveSessionAgentId, g as DEFAULT_HEARTBEAT_FILENAME, h as DEFAULT_BOOTSTRAP_FILENAME, m as DEFAULT_AGENT_WORKSPACE_DIR, p as DEFAULT_AGENTS_FILENAME, r as resolveAgentConfig, v as DEFAULT_SOUL_FILENAME, x as ensureAgentWorkspace, y as DEFAULT_TOOLS_FILENAME } from "./agent-scope-DMje6vKy.js";
import { i as resolveGatewayPort, t as STATE_DIR } from "./paths-BY8fKpqm.js";
import { K as truncateUtf16Safe, r as defaultRuntime, s as CHANNEL_IDS, t as createSubsystemLogger, z as resolveUserPath } from "./subsystem-DGf9i1vB.js";
import { l as resolveAgentIdFromSessionKey, s as normalizeAgentId } from "./session-key-YGVrIVO5.js";
import { n as parseBooleanValue, r as formatCliCommand } from "./env-DTvoLNIG.js";
import { t as generateSecureToken } from "./secure-random-D7Pne8Yn.js";
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-Myp-iLbA.js";
import { _ as getBlockedNetworkModeReason, n as loadConfig, o as writeConfigFile, t as createConfigIO } from "./config-BsU5w2f3.js";
import { A as resolveWritablePathWithinRoot, B as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, C as stopChromeExtensionRelayServer, D as DEFAULT_UPLOAD_DIR, E as DEFAULT_TRACE_DIR, F as DEFAULT_AI_SNAPSHOT_MAX_CHARS, I as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, L as DEFAULT_BROWSER_EVALUATE_ENABLED, N as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, O as resolveExistingPathsWithinRoot, P as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, R as DEFAULT_OPENCLAW_BROWSER_COLOR, S as ensureChromeExtensionRelayServer, T as DEFAULT_DOWNLOAD_DIR, _ as appendCdpPath, a as resolveOpenClawUserDataDir, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, g as withBrowserNavigationPolicy, h as assertBrowserNavigationResultAllowed, i as launchOpenClawChrome, j as isLoopbackHost, l as createTargetViaCdp, m as assertBrowserNavigationAllowed, n as isChromeCdpReady, o as stopOpenClawChrome, p as InvalidBrowserNavigationUrlError, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as fetchJson, y as fetchOk, z as DEFAULT_OPENCLAW_BROWSER_ENABLED } from "./chrome-BwY_WHy0.js";
import { t as SsrFBlockedError } from "./ssrf-CzjOVP3a.js";
import { a as syncSkillsToWorkspace, f as PATH_ALIAS_POLICIES, g as sanitizeEnvVars, l as resolveSandboxInputPath, p as assertNoPathAliasEscape, u as resolveSandboxPath } from "./skills-BnkC2Tc7.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-7W4BIcyZ.js";
import { r as saveMediaBuffer, t as ensureMediaDir } from "./store-BhzdXcBy.js";
import { H as resolveAgentMainSessionKey, V as canonicalizeMainSessionAlias, q as acquireSessionWriteLock } from "./sessions-BqxZ3Ttz.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-t78eqsOg.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai--nTuetWv.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai--nTuetWv.js")).closePlaywrightBrowserConnection();
		} catch {}
