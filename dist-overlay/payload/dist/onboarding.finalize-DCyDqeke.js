...
import { b as waitForGatewayReachable, f as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, m as probeGatewayReachable, o as formatControlUiSshHint } from "./onboard-helpers-ByiIhSd_.js";
...
import { r as isSystemdUserServiceAvailable } from "./systemd-CA3N0I5U.js";
...
import { t as runTui } from "./tui-vZpFLwY_.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-Bj59dK5H.js").then((n) => n.r);
