...
import { zt as resolveOpenClawAgentDir } from "./model-selection-BnthIvhe.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-J-pzuP46.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
