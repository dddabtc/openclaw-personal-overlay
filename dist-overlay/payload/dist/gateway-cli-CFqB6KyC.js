...
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-yu-PHkHH.js";
...
import { n as addGatewayServiceCommands } from "./daemon-cli-BZHeShCh.js";
...
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-CBeWlejv.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines, u as isCronSystemEvent } from "./health-NIAddZun.js";
...
import { t as runGatewayUpdate } from "./update-runner-CEQClUvx.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-B6M0FYKW.js");
