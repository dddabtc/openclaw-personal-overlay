...
import { n as resolveCliChannelOptions } from "./channel-options-Dml5QFk3.js";
import { t as getSubCliCommandsWithSubcommands } from "./register.subclis-BThBCOa4.js";
import { a as registerProgramCommands, r as getCoreCliCommandsWithSubcommands } from "./command-registry-JPgIfJod.js";
import { r as setProgramContext } from "./program-context-DMkrV4MF.js";
import { t as forceFreePort } from "./ports-DlgQ7bTS.js";
import { n as formatCliBannerLine, r as hasEmittedCliBanner, t as emitCliBanner } from "./banner-DujBZPrU.js";
...
function registerPreActionHooks(program, programVersion) {
	program.hook("preAction", async (_thisCommand, actionCommand) => {
		...
		const { ensureConfigReady } = await import("./config-guard-BzSH8eCz.js").then((n) => n.t);
		await ensureConfigReady({
			runtime: defaultRuntime,
			commandPath
		});
		if (PLUGIN_REQUIRED_COMMANDS.has(commandPath[0])) {
			const { ensurePluginRegistryLoaded } = await import("./plugin-registry-nvVa54aJ.js").then((n) => n.n);
