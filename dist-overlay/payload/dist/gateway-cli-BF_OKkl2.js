...
import { d as hasBinary } from "./frontmatter-olEIkgYh.js";
import { r as isPathInsideWithRealpath } from "./scan-paths-DkMlwCU-.js";
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-HuqIMCbl.js";
...
import { $ as BARE_SESSION_RESET_PROMPT, $n as stopSubagentsForRequester, A as createOutboundSendDeps, Ar as emitAgentEvent, At as normalizeCronJobPatch, B as buildHistoryContextFromEntries, Bn as normalizeMimeList, Bt as stripLegacyDeliveryFields, C as computeBackoff, Cn as isSystemEventContextChanged, Cr as CommandLane, Ct as formatRestartSentinelMessage, Dt as writeRestartSentinel, E as agentCommand, En as requestHeartbeatNow, Fn as DEFAULT_INPUT_IMAGE_MIMES, Ft as normalizePayloadToSystemText, Gt as getHookType, Hn as resolveAgentTimeoutMs, In as DEFAULT_INPUT_MAX_REDIRECTS, It as normalizeRequiredName, J as dispatchInboundMessage, Jt as persistBrowserProxyFiles, Kt as isExternalHookSession, Ln as DEFAULT_INPUT_TIMEOUT_MS, Lt as migrateLegacyCronPayload, M as createOutboundSendDeps$1, Mn as getAcpSessionManager, Mr as onAgentEvent, Mt as normalizeOptionalAgentId, N as resolveAgentAvatar, Nn as resolveAgentSessionDirs, Nr as registerAgentRunContext, Nt as normalizeOptionalSessionKey, O as resolveAgentDeliveryPlan, Or as stripHeartbeatToken, Ot as normalizeHttpWebhookUrl, Pn as DEFAULT_INPUT_IMAGE_MAX_BYTES, Pt as normalizeOptionalText, Qn as isAbortRequestText, Rn as extractFileContentFromSource, Rt as buildDeliveryFromLegacyPayload, S as requestBodyErrorToText, Sn as enqueueSystemEvent, Sr as waitForActiveTasks, St as formatDoctorNonInteractiveHint, Tt as summarizeRestartSentinel, Un as normalizeSendPolicy, Ut as buildSafeExternalPrompt, Vn as resolveInputFileLimits, Wn as resolveSendPolicy, Wt as detectSuspiciousPatterns, X as getTotalPendingReplies, Y as createReplyDispatcher, Yn as formatZonedTimestamp, Yt as resolveSessionAuthProfileOverride, _ as loadOpenClawPlugins, _r as getActiveTaskCount, _t as resetDirectoryCache, a as runSubagentAnnounceFlow, an as emitGatewayRestart, ar as isTtsEnabled, at as createOpenClawTools, b as handleSlackHttpRequest, br as resetAllLanes, c as abortEmbeddedPiRun, cn as scheduleGatewaySigusr1Restart, cr as resolveTtsAutoMode, d as applyToolPolicyPipeline, dn as unbindThreadBindingsBySessionKey, dr as resolveTtsProviderOrder, en as applyModelOverrideToSessionEntry, f as buildDefaultToolPolicyPipelineSteps, fn as normalizeGroupActivation, fr as setTtsEnabled, gr as OPENAI_TTS_VOICES, h as resolvePluginTools, hr as OPENAI_TTS_MODELS, ht as resolveOutboundChannelPlugin, in as deferGatewayRestartUntilIdle, ir as getTtsProvider, it as runCliAgent, j as createDefaultDeps, jn as ACP_SESSION_IDENTITY_RENDERER_VERSION, jr as getAgentRunContext, jt as inferLegacyName, k as resolveAgentOutboundTarget, kr as clearAgentRunContext, kt as normalizeCronJobCreate, l as getActiveEmbeddedRunCount, ln as setGatewaySigusr1RestartPolicy, lr as resolveTtsConfig, lt as ensureOutboundSessionEntry, m as getPluginToolMeta, mn as loadProviderUsageSummary, mr as textToSpeech, mt as resolveSessionDeliveryTarget, n as initSubagentRegistry, nn as parseVerboseOverride, nr as resolveUserTimezone, nt as getCliSessionId, o as clearSessionQueues, on as isGatewaySigusr1RestartExternallyAllowed, or as isTtsProviderConfigured, ot as readLatestAssistantReply, pr as setTtsProvider, pt as resolveOutboundTarget, qt as applyBrowserProxyPaths, r as listDescendantRunsForRequester, rn as consumeGatewaySigusr1RestartAuthorization, rr as clearBootstrapSnapshot, rt as setCliSessionId, s as runEmbeddedPiAgent, sn as markGatewaySigusr1RestartHandled, sr as resolveTtsApiKey, st as resolveAnnounceTargetFromKey, t as countActiveDescendantRuns, tn as applyVerboseOverride, tt as resolveCronStyleNow, u as waitForEmbeddedPiRunEnd, un as setPreRestartDeferralCheck, ur as resolveTtsPrefsPath, ut as resolveOutboundSessionRoute, w as sleepWithAbort, wr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, x as readJsonBodyWithLimit, xr as setCommandLaneConcurrency, xt as consumeRestartSentinel, yr as getTotalQueueSize, yt as runWithModelFallback, zn as extractImageContentFromSource, zt as hasLegacyDeliveryHints } from "./subagent-registry-D_kP1cL8.js";
...
import { a as isTrustedProxyAddress, c as pickPrimaryLanIPv4, d as resolveGatewayListenHosts, f as resolveHostName, l as resolveClientIp, n as isLoopbackAddress, o as isValidIPv4, p as rawDataToString, r as isLoopbackHost, s as normalizeHostHeader, t as isLocalishHost, u as resolveGatewayBindHost } from "./net-C5Xzxz5G.js";
import "./ip-CyOZe5YF.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-CC0kbSg4.js";
import { i as isSilentReplyText, n as SILENT_REPLY_TOKEN } from "./tokens-k5g99v2x.js";
import { a as createBrowserControlContext, i as createBrowserRouteDispatcher, o as startBrowserControlServiceFromConfig, r as resolveSystemRunCommand, s as getMachineDisplayName } from "./with-timeout-DkLiP3_U.js";
import { S as getGlobalHookRunner, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads, w as runGlobalGatewayStopSafely } from "./deliver-wdulsjfo.js";
...
import { d as loadCronStore, f as resolveCronStorePath, p as saveCronStore } from "./send-C1iLeH0J.js";
import { c as detectMime } from "./image-ops-BtM0q_Kl.js";
import "./pi-embedded-helpers-CsgdqaKA.js";
import { C as resolveToolProfilePolicy, _ as collectExplicitAllowlist, y as mergeAlsoAllowPolicy } from "./sandbox-DQpHeFtV.js";
...
import { a as resolveGatewayAuth, c as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, i as isLocalDirectRequest, l as createAuthRateLimiter, n as authorizeHttpGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, r as authorizeWsControlUiGatewayConnect, s as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, t as assertGatewayAuthConfigured, u as normalizeRateLimitClientIp } from "./auth-uSllFIea.js";
import { c as ensureGatewayStartupAuth, l as mergeGatewayTailscaleConfig } from "./server-context-8RSvOysq.js";
...
import { t as SsrFBlockedError } from "./ssrf-D2dYwtfF.js";
...
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-B9T45K0l.js";
import { n as resolveMemorySearchConfig } from "./manager-gyw0Q2gC.js";
import "./gemini-auth-Bym9uufz.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-CozZxo_V.js";
...
import { S as extractTextFromChatContent } from "./image-Bi5mjtKi.js";
import "./tool-display-BjKWYkZ_.js";
import { d as registerUnhandledRejectionHandler } from "./runner-BGEicYhv.js";
import { n as loadModelCatalog } from "./model-catalog-BB6eLw3G.js";
import "./fetch-CHNZ_dCB.js";
import { a as readChannelAllowFromStoreSync } from "./pairing-store-C9G8zMVO.js";
...
import { i as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-Cp3AF1aF.js";
...
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-D2QEOku3.js";
import "./replies-CTpi3Yh0.js";
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-ByiIhSd_.js";
...
import { t as resolveChannelDefaultAccountId } from "./helpers-fblCBodX.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-CR1hH5N5.js";
import { t as isWithinDir } from "./path-safety-Bj4TMZKa.js";
...
import "./channels-status-issues-CzmxMm8_.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-cz595NbF.js";
...
import "./lifecycle-core-5DbqsrOX.js";
import "./systemd-hints-CYnJH--R.js";
import { t as parsePort$1 } from "./parse-port-e2GZqX81.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-Du7VqvJ2.js";
import "./diagnostics-iYv_t2Sp.js";
...
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-Bcjk6G1g.js";
import { c as resolveNodeCommandAllowlist, l as probeGateway, n as collectEnabledInsecureOrDangerousFlags, s as isNodeCommandAllowed } from "./audit-TCqiYcU8.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-DpKYbEFu.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-Bd04Wmhi.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-CaKe2UYq.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DCBPreAC.js";
import { h as normalizeUpdateChannel, l as DEFAULT_PACKAGE_CHANNEL, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-KVhwrHjY.js";
import { t as runOnboardingWizard } from "./onboarding-DDFx5-uP.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-BdmY3KKV.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-DLj5g3lP.js";
import "./node-service-6qZUyekI.js";
import "./status.update-DsSJMN5s.js";
import { t as installSkill } from "./skills-install-BP3rCROD.js";
import { t as runGatewayUpdate } from "./update-runner-DUaRmDCQ.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-De53V-MR.js";
import { n as forceFreePortAndWait } from "./ports-DlgQ7bTS.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-D3XoMpWx.js");
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-BMZ9uXsB.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		...
		const { deliverOutboundPayloads } = await import("./deliver-wdulsjfo.js").then((n) => n.n);
