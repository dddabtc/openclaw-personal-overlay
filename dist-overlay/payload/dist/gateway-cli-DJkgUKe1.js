...
import { Et as normalizeSecretInput, G as resolveSubagentConfiguredModelSelection, H as resolveDefaultModelForAgent, Ht as DEFAULT_MODEL, N as getModelRefStatus, O as isPidAlive, P as isCliProvider, U as resolveHooksGmailModel, Ut as DEFAULT_PROVIDER, V as resolveConfiguredModelRef, Vt as DEFAULT_CONTEXT_TOKENS, q as resolveThinkingDefault, z as resolveAllowedModelRef } from "./auth-profiles-C7RTY9Sv.js";
import { t as formatCliCommand } from "./command-format-D3syQOZg.js";
import { S as parseAgentSessionKey, c as normalizeMainKey, f as toAgentRequestSessionKey, l as resolveAgentIdFromSessionKey, m as DEFAULT_ACCOUNT_ID, o as classifySessionKeyShape, p as toAgentStoreSessionKey, r as buildAgentMainSessionKey, s as normalizeAgentId, t as DEFAULT_AGENT_ID, x as isSubagentSessionKey, y as isCronRunSessionKey } from "./session-key-DjZ7Z1hW.js";
...
import { C as ensureAgentWorkspace, D as resolveDefaultAgentWorkspaceDir, O as resolveWorkspaceTemplateDir, S as DEFAULT_USER_FILENAME, T as isWorkspaceOnboardingCompleted, _ as DEFAULT_IDENTITY_FILENAME, a as resolveAgentModelFallbacksOverride, b as DEFAULT_SOUL_FILENAME, c as resolveAgentWorkspaceDir, d as resolveSessionAgentId, g as DEFAULT_HEARTBEAT_FILENAME, h as DEFAULT_BOOTSTRAP_FILENAME, i as resolveAgentDir, l as resolveDefaultAgentId, n as listAgentIds, p as DEFAULT_AGENTS_FILENAME, r as resolveAgentConfig, s as resolveAgentSkillsFilter, t as listAgentEntries, v as DEFAULT_MEMORY_ALT_FILENAME, x as DEFAULT_TOOLS_FILENAME, y as DEFAULT_MEMORY_FILENAME } from "./agent-scope-DhajVyRS.js";
import "./github-copilot-token-DuFIqfeC.js";
import "./model-ChKLb_d2.js";
import "./pi-model-discovery-Do3xMEtM.js";
import { d as hasBinary } from "./frontmatter-D8KtsA8M.js";
import { r as isPathInsideWithRealpath } from "./scan-paths-B22E7-Cg.js";
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-eYanxJfv.js";
import { l as isTestDefaultMemorySlotDisabled } from "./manifest-registry-XSxPcu0S.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BajsVtLY.js";
...
import { a as isValidIPv4, c as resolveClientIp, d as resolveHostName, f as rawDataToString, i as isTrustedProxyAddress, l as resolveGatewayBindHost, n as isLoopbackHost, o as normalizeHostHeader, s as pickPrimaryLanIPv4, t as isLoopbackAddress, u as resolveGatewayListenHosts } from "./net-DZ5Ayk-W.js";
...
import { $n as resolveTtsProviderOrder, A as resolveAgentAvatar, An as resolveInputFileLimits, At as normalizeRequiredName, Bt as isExternalHookSession, C as agentCommand, Cn as DEFAULT_INPUT_IMAGE_MAX_BYTES, Ct as normalizeCronJobCreate, D as createOutboundSendDeps, Dn as extractFileContentFromSource, Dt as normalizeOptionalSessionKey, E as resolveAgentOutboundTarget, En as DEFAULT_INPUT_TIMEOUT_MS, Et as normalizeOptionalAgentId, Gn as resolveUserTimezone, Gt as emitGatewayRestart, H as dispatchInboundMessage, Hn as stopSubagentsForRequester, Ht as persistBrowserProxyFiles, Jn as isTtsProviderConfigured, Jt as scheduleGatewaySigusr1Restart, Kn as getTtsProvider, Kt as isGatewaySigusr1RestartExternallyAllowed, L as buildHistoryContextFromEntries, Lt as buildSafeExternalPrompt, Mn as resolveAgentTimeoutMs, Mt as buildDeliveryFromLegacyPayload, Nt as hasLegacyDeliveryHints, O as createDefaultDeps, On as extractImageContentFromSource, Ot as normalizeOptionalText, Pt as stripLegacyDeliveryFields, Q as runCliAgent, Qn as resolveTtsPrefsPath, Qt as normalizeGroupActivation, Rn as formatZonedTimestamp, Rt as detectSuspiciousPatterns, S as sleepWithAbort, St as normalizeHttpWebhookUrl, T as resolveAgentDeliveryPlan, Tn as DEFAULT_INPUT_MAX_REDIRECTS, Tt as inferLegacyName, U as createReplyDispatcher, Ut as consumeGatewaySigusr1RestartAuthorization, Vn as isAbortTrigger, Vt as applyBrowserProxyPaths, W as getTotalPendingReplies, Wt as deferGatewayRestartUntilIdle, X as getCliSessionId, Xn as resolveTtsAutoMode, Xt as setPreRestartDeferralCheck, Y as resolveCronStyleNow, Yn as resolveTtsApiKey, Yt as setGatewaySigusr1RestartPolicy, Z as setCliSessionId, Zn as resolveTtsConfig, Zt as unbindThreadBindingsBySessionKey, _n as applyVerboseOverride, _r as clearAgentRunContext, _t as formatRestartSentinelMessage, a as runSubagentAnnounceFlow, ar as getActiveTaskCount, at as resolveOutboundSessionRoute, b as requestBodyErrorToText, bn as isSystemEventContextChanged, br as onAgentEvent, c as abortEmbeddedPiRun, cr as resetAllLanes, ct as resolveOutboundTarget, d as applyToolPolicyPipeline, dn as resolveSendPolicy, dr as CommandLane, dt as resetDirectoryCache, en as loadProviderUsageSummary, er as setTtsEnabled, et as createOpenClawTools, f as buildDefaultToolPolicyPipelineSteps, fr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, g as loadOpenClawPlugins, gn as applyModelOverrideToSessionEntry, gr as stripHeartbeatToken, gt as formatDoctorNonInteractiveHint, ht as consumeRestartSentinel, ir as OPENAI_TTS_VOICES, it as ensureOutboundSessionEntry, jt as migrateLegacyCronPayload, k as createOutboundSendDeps$1, kn as normalizeMimeList, kt as normalizePayloadToSystemText, l as getActiveEmbeddedRunCount, lr as setCommandLaneConcurrency, lt as resolveSessionDeliveryTarget, m as getPluginToolMeta, n as initSubagentRegistry, nr as textToSpeech, nt as resolveAnnounceTargetFromKey, o as clearSessionQueues, pt as runWithModelFallback, q as BARE_SESSION_RESET_PROMPT, qn as isTtsEnabled, qt as markGatewaySigusr1RestartHandled, r as listDescendantRunsForRequester, rr as OPENAI_TTS_MODELS, s as runEmbeddedPiAgent, sn as requestHeartbeatNow, sr as getTotalQueueSize, t as countActiveDescendantRuns, tr as setTtsProvider, tt as readLatestAssistantReply, u as waitForEmbeddedPiRunEnd, un as normalizeSendPolicy, ur as waitForActiveTasks, v as handleSlackHttpRequest, vn as parseVerboseOverride, vr as emitAgentEvent, wn as DEFAULT_INPUT_IMAGE_MIMES, wt as normalizeCronJobPatch, x as computeBackoff, xr as registerAgentRunContext, xt as writeRestartSentinel, y as readJsonBodyWithLimit, yn as enqueueSystemEvent, yr as getAgentRunContext, yt as summarizeRestartSentinel, zt as getHookType } from "./subagent-registry-Cc0kGCxw.js";
import { D as resolveSessionResetPolicy, F as resolveMainSessionKey, H as cleanStaleLockFiles, I as resolveMainSessionKeyFromConfig, J as normalizeSessionDeliveryFields, K as mergeDeliveryContext, M as canonicalizeMainSessionAlias, N as resolveAgentMainSessionKey, P as resolveExplicitAgentSessionKey, R as snapshotSessionOrigin, S as stripEnvelopeFromMessages, T as evaluateSessionFreshness, W as deliveryContextFromSession, _ as capArrayByJsonBytes, d as updateSessionStore, g as archiveSessionTranscripts, h as archiveFileOnDisk, n as parseSessionThreadInfo, o as loadSessionStore, t as extractDeliveryInfo, v as readSessionMessages, x as resolveSessionTranscriptCandidates, y as readSessionPreviewItemsFromTranscript } from "./sessions-BfWM-oFg.js";
import { i as isSilentReplyText, n as SILENT_REPLY_TOKEN } from "./tokens-ANnYrShl.js";
import { n as listChannelPlugins, o as normalizeWhatsAppTarget, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-Dhh2a3qc.js";
import { n as resolveWhatsAppAccount } from "./accounts-BrsscXpo.js";
import { t as buildChannelAccountBindings } from "./bindings-BO7DQ_-I.js";
import "./logging-CFvkxgcX.js";
import "./send-CwH6VQLi.js";
import "./send-znMAbXL-.js";
import { n as createBrowserRouteDispatcher, r as getMachineDisplayName } from "./with-timeout-CAOVAeKU.js";
import { C as getGlobalHookRunner, T as runGlobalGatewayStopSafely, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-CLUHfJ7h.js";
import { d as startDiagnosticHeartbeat, f as stopDiagnosticHeartbeat, m as isDiagnosticsEnabled } from "./diagnostic-C6WTf4ZE.js";
import "./diagnostic-session-state-CIjIGxEE.js";
import "./accounts-1gFWxwAw.js";
import "./send-CKMBUMOp.js";
import { c as detectMime } from "./image-ops-CKJNUuNW.js";
import "./pi-embedded-helpers-N0lTe6ZJ.js";
import { S as resolveToolProfilePolicy, _ as collectExplicitAllowlist, b as mergeAlsoAllowPolicy } from "./sandbox-D-5UkuzR.js";
import "./chrome-DGy95ia1.js";
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-BxzsxqAY.js";
import { a as resolveGatewayAuth, c as createAuthRateLimiter, i as isLocalDirectRequest, n as authorizeHttpGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, r as authorizeWsControlUiGatewayConnect, s as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, t as assertGatewayAuthConfigured } from "./auth-BcWLEKcS.js";
import { g as mergeGatewayTailscaleConfig, h as ensureGatewayStartupAuth } from "./server-context-BbjbRa1R.js";
import "./routes-2DlmfGiB.js";
import "./redact-B40lik2B.js";
import { a as isErrno, n as formatErrorMessage } from "./errors-Ba_ROWsq.js";
import { n as openFileWithinRoot, t as SafeOpenError } from "./fs-safe-CERgjtot.js";
import "./paths-Dzc_6Z5O.js";
import { t as SsrFBlockedError } from "./ssrf-Ixuyn7h8.js";
import "./store-DRvx-vgM.js";
import { a as formatPortDiagnostics, n as inspectPortUsage, t as ensurePortAvailable } from "./ports-CjVslX4J.js";
import { t as movePathToTrash } from "./trash-CWQQXWX3.js";
import "./dock-BkVflx2Q.js";
import "./accounts-CuhuCyTF.js";
import { c as resolveStorePath, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-DNdWAq7b.js";
import "./tool-images-CW04CAn5.js";
import { a as normalizeElevatedLevel, c as normalizeUsageDisplay, d as supportsXHighThinking, l as normalizeVerboseLevel, n as formatXHighModelHint, o as normalizeReasoningLevel, s as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-8sKPnzpp.js";
import "./models-config-DLZ0qBzl.js";
import { a as resolveAgentIdentity, t as createReplyPrefixOptions } from "./reply-prefix-D4RfrCeP.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-0uYtPYU9.js";
import { n as resolveMemorySearchConfig } from "./manager-CYx1MWZA.js";
import "./gemini-auth-FuBGrv0B.js";
import "./sqlite-CQGamAhm.js";
import "./retry-C4Q_VPOo.js";
import { a as ToolInputError } from "./target-errors-C6mkRlU9.js";
...
import { r as isRestartEnabled } from "./commands-j9S9qRB6.js";
...
import { c as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as deriveSessionTotalTokens, t as discoverAllSessions } from "./session-cost-usage-Dfx7NHjv.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-BMWvYDjj.js";
import { d as registerUnhandledRejectionHandler } from "./runner-DmUzWvVT.js";
import { n as loadModelCatalog } from "./model-catalog-jsoULWdH.js";
import { S as registerSkillsChangeListener, _ as requestNodePairing, c as recordRemoteNodeInfo, d as removeRemoteNodeInfo, f as setSkillsRemoteRegistry, g as renamePairedNode, h as rejectNodePairing, l as refreshRemoteBinsForConnectedNodes, m as listNodePairing, o as getRemoteSkillEligibility, p as approveNodePairing, s as primeRemoteSkillsCache, u as refreshRemoteNodeBins, v as updatePairedNodeMetadata, x as getSkillsSnapshotVersion, y as verifyNodeToken } from "./skill-commands-BMTXwSBr.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-Dw0EowUJ.js";
import { a as readChannelAllowFromStoreSync } from "./pairing-store-BqeL7tj7.js";
import "./fetch-DOex5qYK.js";
import { a as mergeExecApprovalsSocketDefaults, c as readExecApprovalsSnapshot, p as saveExecApprovals, r as ensureExecApprovals, s as normalizeExecApprovals, t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-BKZqQjp9.js";
import "./nodes-screen-DCJNznUw.js";
import { t as getChannelActivity } from "./channel-activity-myOnmDZi.js";
import { n as normalizePollInput } from "./polls-DXeUmcgz.js";
import "./tables-CKA-N6SU.js";
import { n as createBrowserControlContext, r as startBrowserControlServiceFromConfig } from "./control-service-Br6yHjdV.js";
import { i as parseAbsoluteTimeMs, n as resolveCronStaggerMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-CQar2eKe.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-D5cjTEHf.js";
...
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-VhYln9Mp.js";
import "./prompt-style-DwCXob2h.js";
import "./pairing-labels-D4ymYAjE.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-CrxWkGkW.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-B8TDjqpW.js";
...
import { t as buildChannelUiCatalog } from "./catalog-Da8o-cxw.js";
...
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-Ccy8kRB0.js";
...
import "./lifecycle-core-DIg4pg2m.js";
import "./systemd-hints-Cd-yRMdt.js";
import { t as parsePort$1 } from "./parse-port-DnJYkByg.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-DZccjK_A.js";
import "./diagnostics-CqEodocN.js";
import "./table-C9BoE_4p.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-Bm3RmzUh.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-BLko2ysA.js";
import { c as probeGateway, o as isNodeCommandAllowed, s as resolveNodeCommandAllowlist } from "./audit-avSnAtKk.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-Dey40AZW.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-CUxEKIov.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-Bt4gX0UL.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-BC2GSxMJ.js";
import { a as resolveNpmChannelTag, c as DEFAULT_PACKAGE_CHANNEL, m as normalizeUpdateChannel, n as compareSemverStrings, t as checkUpdateStatus } from "./update-check-DfBZVR4k.js";
import { t as runOnboardingWizard } from "./onboarding-A3D_Qhgd.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-Dqev6UG3.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-POpQUecI.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-BJO8Sk_G.js";
...
import { t as installSkill } from "./skills-install-CADLQdE4.js";
import { n as runGatewayUpdate, t as resolveAgentSessionDirs } from "./session-dirs-CP9w1S6u.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-VUemvePY.js";
import { n as forceFreePortAndWait } from "./ports-BxzJ3ENr.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BqXnj_C3.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-Dfx7NHjv.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-Br6yHjdV.js").then((n) => n.t);
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-CzNZXd1M.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-CLUHfJ7h.js").then((n) => n.n);
